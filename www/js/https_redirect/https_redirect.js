...
var $scan_title = $("<div>").addClass("scan_title").appendTo($scan_qr_code_block).html("<#4239#>");
...
$("<label>").attr("for","https_redirect_hint").html("<#4243#>").appendTo($cb_text_bg);
...
var $btn_yes = $("<div>").html("<#187#>").appendTo($btn_bg);
