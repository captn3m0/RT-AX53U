...
var $scan_title = $("<div>").addClass("scan_title").appendTo($scan_qr_code_block).html("<#4195#>");
...
$("<label>").attr("for","https_redirect_hint").html("<#4199#>").appendTo($cb_text_bg);
var $btn_bg = $("<div>").addClass("btn_bg").appendTo($action_bg);
var $btn_no = $("<div>").html("<#185#>").appendTo($btn_bg);
...
var $btn_yes = $("<div>").html("<#186#>").appendTo($btn_bg);
