...
<div>&nbsp;</div>
<div class="formfonttitle"><#742#> - <#411#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2213#></div>
...
<tr>
<th><#2212#></a></th>
<td><span id="boot_days"></span> <#1679#> <span id="boot_hours"></span> <#2245#> <span id="boot_minutes"></span> <#2622#> <span id="boot_seconds"></span> <#3047#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#2545#></a></th>
<td>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1636#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1655#>" class="button_gen">
</form>
</td>
</tr>
</table>
