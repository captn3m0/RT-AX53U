...
$("#dualwan_primary_title").html("<#1881#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1881#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1888#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1888#> - "+dualwan_secondary_display);
}
...
code += '<td colspan="5"><#1643#>&nbsp;(<#2656#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3156#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1413#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1413#></div></div>';
code += '</th>';
if(pm_support)
...
code += '<th style="width:130px"><#1813#></th>';
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2318#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<input class="button_gen" type="button" onclick="save_priority();" value="<#1688#>">
</div>
</td>
</tr>
</form>
...
<#1922#>
<ul>
<li id="function_int_desc"><#1923#></li>
<li id="qos_desc"><#1926#></li>
<li><#1924#></li>
</ul>
<#1925#>
</div>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1930#></div>
</td>
</tr>
...
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1933#></label></a>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1813#></a></th>
<td>
...
<div class="Quick_Setup_title"><#1253#></div>
</div>
<div style="width: 120px;height:174px;">
<div style="display:flex;height:132px;">
...
<div class="Quick_Setup_title"><#1703#></div>
</div>
</div>
</div>
