...
var category_title = ["", "<#885#>", "<#897#>", "<#889#>", "<#899#>","<#884#>", "<#891#>", "<#901#>"];
...
$("#dualwan_primary_title").html("<#1846#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1846#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1853#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1853#> - "+dualwan_secondary_display);
}
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2616#> - <#893#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#2971#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#2970#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#373#> - <#2616#>";
...
alert("<#3474#> "+ (qos_xobw_orig/1024).toFixed(2));
...
alert("<#3474#> "+(qos_xobw1_orig/1024).toFixed(2));
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#329#>");
return false;
}
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2598#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#2871#>&nbsp;(<#2576#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1611#>&nbsp;(<#2576#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3049#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1385#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1385#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2781#></th>';
else
code += '<th style="width:330px"><#2781#></th>';
code += '<th style="width:130px"><#1778#></th>';
code += '<th style="width:130px"><#3410#></th>';
code += '<th style="width:90px"><#2575#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#1184#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
...
<tr>
<div class="description_down"><#892#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#894#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2243#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2588#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" id="btn_cancel_priority" type="button" onclick="cancel_priority_panel();" value="<#198#>">
<input class="button_gen" type="button" onclick="save_priority();" value="<#1655#>">
</div>
</td>
</tr>
</form>
...
<#1887#>
<ul>
<li id="function_int_desc"><#1888#></li>
<li id="qos_desc"><#1891#></li>
<li><#1889#></li>
</ul>
<#1890#>
</div>
...
<th><#2210#></th>
<td colspan="2">
<input type="radio" name="nvgfn_enable" class="input" value="1" <% nvram_match("nvgfn_enable", "1", "checked"); %>><#186#>
<input type="radio" name="nvgfn_enable" class="input" value="0" <% nvram_match("nvgfn_enable", "0", "checked"); %>><#185#>
</td>
</tr>
<tr>
<th><#1867#></th>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1895#></div>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#2969#></th>
<td colspan="3">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#892#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1898#></label></a>
<input id="bw_limit_type" name="qos_type_radio" value="2" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 7)"><label for="bw_limit_type"><#154#></label></a>
...
<th><#1423#></th>
<td colspan="2">
<input id="auto" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="auto"><#153#></label>
<input id="manu" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="manu"><#370#></label>
</td>
</tr>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3410#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1778#></a></th>
<td>
...
<tr>
<td height="50" >
<div style=" *width:136px;margin-left:300px;" class="titlebtn" align="center" onClick="submitQoS();"><span><#195#></span></div>
</td>
</tr>
</table>
</td>
