...
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#4336#></div>';
...
banner_code +='<div style="padding:5px 0 5px 15px;font-size:14px;color:#BDBDBD"><#1424#></div>';
banner_code +='</div>';
banner_code +='</div>';
...
footer_code += '<td width="20" align="right"><div id="bottom_help_icon" style="margin-right:3px;"></div></td><td width="110" id="bottom_help_title" align="left"><#2311#> & <#3305#></td>';
...
code += '<div style="margin: 24px 0;"><#4337#></div>';
var _str = '<#4338#>';
var _str1 = '<#4339#>';
var _temp = _str.replace('%1$@', 'WiFi radio').replace('%2$@', _str1);
code += '<div style="margin: 24px 0;">'+ _temp +'</div>';
code += '<div style="margin: 32px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4340#></div>';
...
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;" onclick="radio_agree();"><div class="button-icon button-icon-check"></div><div class="button-text"><#4339#></div></div>';
code += '</div></div>';
obj.html(code);
}
...
if(_flag == "1")
code += '<div style="margin: 18px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4340#></div>';
...
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;"><div class="button-icon button-icon-check"></div><div class="button-text"><#1536#></div></div>';
code += '</div></div>';
obj.html(code);
