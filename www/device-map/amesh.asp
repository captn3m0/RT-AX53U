...
html += "<div class='aimesh_node_setting_info_title'><#4103#></div>";
...
case "ctrl_led" :
html += "<div style='margin-top:10px;'>";
html += "<div class='aimesh_node_setting_info_title'><#4129#></div>";
html += "<div class='aimesh_node_setting_info_content'>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2372#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
parent.$("#amesh_connect_msg").find(".amesh_hint_text.amesh_hint_title").html("<#1031#>");
}
});
});
}
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#2117#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1529#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1654#>"});
...
$amesh_wait_search_text.html("<#1024#>");
...
$amesh_cancel.attr({"type" : "button", "value" : "<#198#>"});
$amesh_action_bg.append($amesh_cancel);
$amesh_cancel.click(
function() {
initial_amesh_obj();
...
$amesh_apply.attr({"type" : "button", "value" : "<#195#>"});
...
var auth_change_str = "* <#915#> <#1005#>".replace("WPA3-personal", current_auth).replace("WPA2/WPA3-personal", changeTo_auth);
$amesh_wpa3_text.append($("<div>").html(auth_change_str).css("color", "#FC0"));
$amesh_wpa3_text.append($("<div>").html("<#1006#>"));
...
$aimesh_illustration_bg.append(gen_text("<#1099#>", "backhaul_router"));
$aimesh_illustration_bg.append(gen_text("<#1030#>", "backhaul_node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1030#>", "backhaul_node for_dsl"));
}
...
result_text += "<li><#1027#></li>";
result_text += "<li><#1028#></li>";
result_text += "<li><#1093#></li>";
result_text += "<li><#1029#></li>";
result_text += "<li><#1017#></li>";
result_text += "</ol>";
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
result_text += "<#1014#>";
result_text += "<div style='margin-left: 20px;'>1. <#1015#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1016#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1017#></div>";
result_text += "<div style='margin-left: 20px;'>4. <#1018#></div>";
}
if(ameshRouter_support && ameshNode_support)
result_text += "b. ";
if(ameshNode_support){
result_text += "<#1019#>";
result_text += "<div style='margin-left: 20px;'>1. <#1020#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1021#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1022#></div>";
}
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
$aimesh_illustration_bg.append(gen_text("Modem", "modem"));
$aimesh_illustration_bg.append(gen_text("<#1099#>", "router"));
$aimesh_illustration_bg.append(gen_text("<#1030#>", "node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1030#>", "node for_dsl"));
}
var $amesh_clear_bg = $('<div>');
$amesh_clear_bg.css("clear", "both");
$aimesh_illustration_bg.append($amesh_clear_bg);
...
$amesh_apply.attr({"type" : "button", "value" : "<#1654#>"});
$amesh_action_bg.append($amesh_apply);
$amesh_apply.click(
function() {
initial_amesh_obj();
...
hint += "<#1172#>";
hint += "<br>";
hint += "<#1173#> <#1174#>".replace("#RE_MAXNUM", cfg_re_maxnum);
hint += "<br>";
hint += "<#1175#>";
...
var location_array = [
{value:"Home",text:"<#1067#>"}, {value:"Living Room",text:"<#1068#>"}, {value:"Dining Room",text:"<#1069#>"},
{value:"Bedroom",text:"<#1070#>"}, {value:"Office",text:"<#1071#>"}, {value:"Stairwell",text:"<#1072#>"},
{value:"Hall",text:"<#1073#>"}, {value:"Kitchen",text:"<#1074#>"}, {value:"Attic",text:"<#1075#>"},
{value:"Basement",text:"<#1076#>"}, {value:"Yard",text:"<#1077#>"}, {value:"Master Bedroom",text:"<#1078#>"},
{value:"Guest Room",text:"<#1079#>"}, {value:"Kids Room",text:"<#1080#>"}, {value:"Study Room",text:"<#1081#>"},
{value:"Hallway",text:"<#1082#>"}, {value:"Walk-in Closet",text:"<#1083#>"}, {value:"Bathroom",text:"<#1084#>"},
{value:"Second Floor",text:"<#1085#>"}, {value:"Third Floor",text:"<#1086#>"}, {value:"Storage",text:"<#1087#>"},
{value:"Balcony",text:"<#1088#>"}, {value:"Meeting Room",text:"<#1089#>"}, {value:"Garage",text:"<#1091#>"},
{value:"Custom",text:"<#1090#>"}];
...
code += "<div class='aimesh_node_static_info_title'><#1066#></div>";
...
code += "<div class='aimesh_node_static_info_title'><#289#></div>";
...
code += "<div>";
code += "<div class='aimesh_node_setting_info_title'><#362#></div>";
code += "<div id='aimesh_node_macaddr' class='aimesh_node_setting_info_content'></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#1052#></div>";
code += "<select id='aimesh_node_connection_priority' class='aimesh_node_input_select'>";
code += "<option value='3' class='aimesh_node_input_select_option'><#152#></option>";
code += "<option value='2' class='aimesh_node_input_select_option'><#1042#></option>";
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1653#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#191#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_connection_type' class='text_hyperlink'></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#2126#></div>";
...
code += "<div class='aimesh_node_setting_info_title'><#376#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_usb_app' class='text_hyperlink'><#374#></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1522#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#2832#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3482#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3632#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2729#>");
...
block_chars_hint = block_chars_array[i] + " <#2439#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1637#>" : "<#2729#>";
...
var led_table = ["<#1637#>", "<#2587#>", "<#2609#>", "<#2242#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1637#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2372#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4102#>" : nodeClientObj.ip;
...
option_array.push(gen_option_attr("3", ((_eap_flag) ? "<#152#> (<#1047#>)" : "<#152#>"), "auto"));
...
var option_text = (_eap_flag) ? "<#1057#>" : "<#1056#>";
...
option_array.push(gen_option_attr("2", ((_eap_flag) ? "<#1046#>" : "<#1042#>"), "eth"));
return option_array;
}
...
<tr>
<td colspan="2">
<div class="amesh_title"><#1009#></div>
<div class="amesh_title amesh_content"><#1012#></div>
</td>
</tr>
...
<tr>
<td width="50%">
<div class="amesh_title amesh_help" onclick="scenario();"><#1010#></div>
</td>
<td width="50%" height="32px;" style="text-align:center;">
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1661#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2372#></div></div>
</td>
</tr>
<tr>
</table>
