...
html += "<div class='aimesh_node_setting_info_title'><#4115#></div>";
...
case "ctrl_led" :
html += "<div style='margin-top:10px;'>";
html += "<div class='aimesh_node_setting_info_title'><#4141#></div>";
html += "<div class='aimesh_node_setting_info_content'>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2382#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
parent.$("#amesh_connect_msg").find(".amesh_hint_text.amesh_hint_title").html("<#1033#>");
}
});
});
}
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#2124#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1534#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1659#>"});
...
$amesh_wait_search_text.html("<#1026#>");
...
$amesh_cancel.attr({"type" : "button", "value" : "<#199#>"});
$amesh_action_bg.append($amesh_cancel);
$amesh_cancel.click(
function() {
initial_amesh_obj();
...
$amesh_apply.attr({"type" : "button", "value" : "<#196#>"});
...
var auth_change_str = "* <#916#> <#1006#>".replace("WPA3-personal", current_auth).replace("WPA2/WPA3-personal", changeTo_auth);
$amesh_wpa3_text.append($("<div>").html(auth_change_str).css("color", "#FC0"));
$amesh_wpa3_text.append($("<div>").html("<#1007#>"));
...
$aimesh_illustration_bg.append(gen_text("<#1104#>", "backhaul_router"));
$aimesh_illustration_bg.append(gen_text("<#1032#>", "backhaul_node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1032#>", "backhaul_node for_dsl"));
}
...
result_text += "<li><#1030#></li>";
result_text += "<li><#1098#></li>";
result_text += "<li><#1031#></li>";
result_text += "<li><#1019#></li>";
result_text += "</ol>";
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
result_text += "<#1016#>";
result_text += "<div style='margin-left: 20px;'>1. <#1017#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1018#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1019#></div>";
result_text += "<div style='margin-left: 20px;'>4. <#1020#></div>";
}
if(ameshRouter_support && ameshNode_support)
result_text += "b. ";
if(ameshNode_support){
result_text += "<#1021#>";
result_text += "<div style='margin-left: 20px;'>1. <#1022#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1023#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1024#></div>";
}
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
$aimesh_illustration_bg.append(gen_text("Modem", "modem"));
$aimesh_illustration_bg.append(gen_text("<#1104#>", "router"));
$aimesh_illustration_bg.append(gen_text("<#1032#>", "node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1032#>", "node for_dsl"));
}
var $amesh_clear_bg = $('<div>');
$amesh_clear_bg.css("clear", "both");
$aimesh_illustration_bg.append($amesh_clear_bg);
...
$amesh_apply.attr({"type" : "button", "value" : "<#1659#>"});
$amesh_action_bg.append($amesh_apply);
$amesh_apply.click(
function() {
initial_amesh_obj();
...
hint += "<#1177#>";
hint += "<br>";
hint += "<#1178#> <#1179#>".replace("#RE_MAXNUM", cfg_re_maxnum);
hint += "<br>";
hint += "<#1180#>";
...
code += "<div class='aimesh_node_static_info_title'><#1068#></div>";
...
code += "<div class='aimesh_node_static_info_title'><#290#></div>";
...
code += "<div>";
code += "<div class='aimesh_node_setting_info_title'><#363#></div>";
code += "<div id='aimesh_node_macaddr' class='aimesh_node_setting_info_content'></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#1054#></div>";
code += "<select id='aimesh_node_connection_priority' class='aimesh_node_input_select'>";
code += "<option value='3' class='aimesh_node_input_select_option'><#153#></option>";
code += "<option value='2' class='aimesh_node_input_select_option'><#1044#></option>";
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1658#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#192#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_connection_type' class='text_hyperlink'></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#2133#></div>";
...
code += "<div class='aimesh_node_setting_info_title'><#377#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_usb_app' class='text_hyperlink'><#375#></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1527#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#2842#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3494#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3644#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2739#>");
...
block_chars_hint = block_chars_array[i] + " <#2449#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1642#>" : "<#2739#>";
...
var led_table = ["<#1642#>", "<#2597#>", "<#2619#>", "<#2252#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1642#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2382#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4114#>" : nodeClientObj.ip;
...
option_array.push(gen_option_attr("3", ((_eap_flag) ? "<#153#> (<#1049#>)" : "<#153#>"), "auto"));
...
var option_text = (_eap_flag) ? "<#1059#>" : "<#1058#>";
...
option_array.push(gen_option_attr("2", ((_eap_flag) ? "<#1048#>" : "<#1044#>"), "eth"));
return option_array;
}
...
<tr>
<td colspan="2">
<div class="amesh_title"><#1011#></div>
<div class="amesh_title amesh_content"><#1014#></div>
</td>
</tr>
...
<tr>
<td width="50%">
<div class="amesh_title amesh_help" onclick="scenario();"><#1012#></div>
</td>
<td width="50%" height="32px;" style="text-align:center;">
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1666#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2382#></div></div>
</td>
</tr>
<tr>
</table>
