...
overlibStr += "<p><#874#>:</p>" + client.wlConnectTime;
}
}
return overlibStr;
}
...
<input type="button" id="refresh_list" class="button_gen" value="<#1668#>" style="margin-left:70px;">
<script>
