...
if(noaidisk_support)
document.getElementById("aidisk_hyperlink").style.display = "none";
if((based_modelid == "DSL-AC68U" || based_modelid == "RT-AC3200" || based_modelid == "RT-AC87U" || based_modelid == "RT-AC68U" || based_modelid == "RT-AC68A" || based_modelid == "RT-AC56S" || based_modelid == "RT-AC56U" || based_modelid == "RT-AC55U" || based_modelid == "RT-AC55UHP" || based_modelid == "RT-N18U" || based_modelid == "RT-AC88U" || based_modelid == "RT-AC86U" || based_modelid == "GT-AC2900" || based_modelid == "RT-AC3100" || based_modelid == "RT-AC5300" || based_modelid == "RP-AC68U" || based_modelid == "RT-AC58U" || based_modelid == "RT-AC82U" || based_modelid == "MAP-AC3000" || based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-AC65U" || based_modelid == "4G-AC68U" || based_modelid == "BLUECAVE" || based_modelid == "RT-AX92U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "RT-AX56_XD4" || based_modelid == "XD4PRO" || based_modelid == "CT-AX56_XD4" || based_modelid == "RT-AX58U" || based_modelid == "RT-AX58U_V2" || based_modelid == "TUF-AX3000" || based_modelid == "TUF-AX3000_V2" || based_modelid == "TUF-AX5400" || based_modelid == "DSL-AX82U" || based_modelid == "RT-AX82U" || based_modelid == "RT-AX56U" || based_modelid == "GS-AX3000" || based_modelid == "GS-AX5400" || productid == "RT-AX86S" || based_modelid == "RT-AX68U" || based_modelid == "RT-AXE7800") && parent.currentUsbPort == 0){
...
disk_list_array = { "info" : ["<#1771#>", "disk.asp"], "health" : ["<#1764#>", "disk_utility.asp"], "format" : ["<#1680#>", "disk_format.asp"]};
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1443#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#3386#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#797#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#1540#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1012#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#1540#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="dmLink" style="display:none;">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1807#>:</p>
<input type="button" class="button_gen" onclick="gotoDM();" value="<#1540#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#3133#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#1542#>">
<div id="show_removed_string" style="display:none;"><#3131#></div>
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; " onmouseover="parent.overHint(24);" onmouseout="parent.nd();"><#3166#></p>
...
<li><#1787#><a href="/" target="_parent"><#1788#></a><#1789#></li>
</ul>
</div>
