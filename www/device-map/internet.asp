...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1679#> ";
if (Hours != 0)
value += Hours.toString() + " <#2245#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2622#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3047#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
if(gobi_support){
pri_if = (pri_if == "USB")? "<#2705#>" : pri_if;
sec_if = (sec_if == "USB")? "<#2705#>": sec_if;
if((unit == "0" && pri_if == "<#2705#>") || (unit == "1" && sec_if == "<#2705#>"))
$("#wan_enable_title").text("<#2626#>");
}
...
showtext(document.getElementById("dualwan_mode"), "<#1830#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1829#>");
...
showtext(document.getElementById("LanProto"), "<#166#>");
...
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;" id="wan_enable_title"><#389#></div>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<div style="display:flex; align-items:center; justify-content:space-between;">
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;"><#1815#></div>
...
<p class="formfonttitle_nwm"><#3674#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3672#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1828#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1831#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#191#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3634#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#307#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3931#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3018#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2481#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2567#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#221#></p>
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1511#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1514#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1511#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<p class="formfonttitle_nwm"><#737#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2465#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#305#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2252#></p>
...
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#597#>" style="float:right;margin: 5px 0;">
</td>
</tr>
</table>
</form>
