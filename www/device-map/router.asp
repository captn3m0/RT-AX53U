...
var _temp = new Array();
var typeObj = {
'triBandSmartConnect': [['0', '<#3129#>', '0']],
'dualBand6GHzSmartConnect': [['0', '2.4 / 5 GHz', '0'], ['2', '6 GHz', '2']],
'dualBandSmartConnect': [['0', '<#3128#>', '0']],
'triBand5GHzSmartConnect': [['0', '2.4 GHz', '0'], ['1', '5GHz Smart Connect', '1']],
'triBandMeshSmartConnect': [['0', '<#3128#>', '0'], ['2', '5 GHz-2', '2']],
'triBand6GHzMeshSmartConnect': [['0', '<#3128#>', '0'], ['2', '6 GHz', '2']],
...
code += '<div class="button-right"><input type="button" class="button_gen" value="<#597#>" onclick="gotoSiteSurvey();"></div>';
code += '</div>';
...
code += '<div class="info-title"><#3126#></div>';
...
code += '<div class="dwb_hint"><#54#></div>';
break;
}
else{
...
code += '<div class="info-block">';
code += '<div class="info-title"><#557#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3737#></div>';
...
code += '<span><#1004#> <a id="wl'+ unit +'_wpa3FaqLink" class="faq-link" target="_blank" href="">FAQ</a></span>';
code += '</div>';
}
...
if(!system.lyraHideSupport){
code += '<div class="info-block">';
code += '<div class="info-title"><#848#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3915#></div>';
...
if(system.band5g2Support){
if(dwb_info.mode == '1'){
_optionArray = [['<#842#>', '0'], ['<#3128#>', '1']];
}
else{
if(isSupport("wifi6e")){
_optionArray = [['<#842#>', '0'], ['<#3129#>', '1'], ['<#3128#>', '3']];
}
else{
_optionArray = [['<#842#>', '0'], ['<#3129#>', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
...
<div id="wireless_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#377#></div>
<div id="status_tab" class="tab-block" onclick="switchTab(this.id)"><#726#></div>
...
<input type="button" class="button_gen" value="<#195#>" onclick="apply();">
</div>
</div>
</body>
</html>
