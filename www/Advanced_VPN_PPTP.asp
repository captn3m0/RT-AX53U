...
document.getElementById("dualwan_ctrl").innerHTML = "<#2933#> <span class=\"formfontdesc\">Primary WAN IP : " + wan0_ipaddr + " </sapn><span class=\"formfontdesc\">Secondary WAN IP : " + wan1_ipaddr + "</sapn>";
...
document.getElementById("wan_ctrl").innerHTML = "<#2933#>" + wan_ipaddr;
...
$rowObj.children(":first").html('<a class="hintstyle2" href="javascript:void(0);" onClick="showPPTPClients(\''+pptpd_connected_clients[y].username+'\');"><#188#></a>');
}
break;
}
}
...
$rowObj.children(":first").html("<#2372#>");
else
...
alert(document.form._pptpd_clients_start.value + " <#329#>");
document.form._pptpd_clients_start.focus();
document.form._pptpd_clients_start.select();
return false;
}
...
alert("<#3473#> " + document.form._pptpd_clients_start.value);
document.form._pptpd_clients_end.focus();
document.form._pptpd_clients_end.select();
setEnd();
return false;
...
document.getElementById("pptpd_conflict").innerHTML = "<#3486#> <b>"+origin_lan_ip+"</b>";
return;
}
...
document.getElementById("pptpd_conflict").innerHTML = "<#3484#> <b>"+pool_start+" ~ "+pool_end+"</b>";
return;
}
if(dhcp_staticlists != ""){
...
document.getElementById("pptpd_conflict").innerHTML = "<#3485#> <b>"+static_ip+"</b>";
return;
}
}
}
...
<div>&nbsp;</div>
<div id="divVPNTitle" class="formfonttitle"><#169#> - PPTP</div>
<div id="divSwitchMenu" style="margin-top:-40px;float:right;"></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="privateIP_notes" class="formfontdesc" style="display:none;color:#FC0;"><#3552#></div>
...
<th><#3498#></th>
<td>
<input type="radio" value="1" name="pptpd_ms_network_option" onClick="set_pptpd_broadcast(this);"/><#186#>
<input type="radio" value="0" name="pptpd_ms_network_option" onClick="set_pptpd_broadcast(this);"/><#185#>
</td>
</tr>
</table>
<div id="PPTP_setting" style="display:none;margin-top:8px;">
<div class="formfontdesc"><#2932#></div>
<div id="wan_ctrl" class="formfontdesc"></div>
<div id="dualwan_ctrl" style="display:none;" class="formfontdesc"></div>
<div class="formfontdesc" style="margin-top:-10px;"><#2934#></div>
<div class="formfontdesc" style="margin-top:-10px;">(7) <#2801#></div>
<div class="formfontdesc" style="margin:-10px 0px 0px -15px;">
<ul>
<li>
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#169#> FAQ</a>
</li>
</ul>
</div>
...
<th><#3478#></th>
<td>
<input type="radio" value="1" name="pptpd_broadcast_option" onClick="setBroadcast(this);"/><#186#>
<input type="radio" value="0" name="pptpd_broadcast_option" onClick="setBroadcast(this);"/><#185#>
<span id="pptpd_broadcast_hint" style="font-family: Lucida Console;color: #FFCC00;display: none;"><#2931#></span>
</td>
</tr>
<tr>
<th><#2899#></th>
...
<option value="0" <% nvram_match("pptpd_chap", "0","selected"); %>><#152#></option>
...
<input type="checkbox" class="input" name="pptpd_mppe_no" onClick="return changeMppe();"><#2789#>
</td>
</tr>
<tr>
<th><#303#></th>
<td>
<input type="radio" name="pptpd_dnsenable_x" class="input" value="1" onclick="return change_pptpd_radio(this)" /><#186#>
<input type="radio" name="pptpd_dnsenable_x" class="input" value="0" onclick="return change_pptpd_radio(this)" /><#185#>
</td>
</tr>
<tr>
<th><#293#></th>
...
<th><#2390#></th>
<td>
<input type="radio" name="pptpd_winsenable_x" class="input" value="1" onclick="return change_pptpd_radio(this)" /><#186#>
<input type="radio" name="pptpd_winsenable_x" class="input" value="0" onclick="return change_pptpd_radio(this)" /><#185#>
</td>
</tr>
<tr>
<th><#2388#></th>
...
<span id="pptpd_subnet" style="font-family: Lucida Console;color: #FFF;"></span><input type="text" maxlength="3" class="input_3_table" name="_pptpd_clients_end" value="" autocorrect="off" autocapitalize="off"/><span style="color:#FFCC00;"> <#3496#></span>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,1);"><#3019#></a></th>
<td>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,2);"><#3020#></a></th>
<td>
...
<input class="button_gen" type="button" onclick="srConfirm();" value="<#1654#>">
</div>
</div>
</form>
<div id="footer"></div>
