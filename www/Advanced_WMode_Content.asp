...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1653#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1392#></div>';
}
else{
...
document.getElementById("check_mac").innerHTML="<br><br><#347#>";
...
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<br><br><#308#>";
document.getElementById("check_mac").style.display = "";
return false;
}else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#377#> - <#380#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3750#></div>
<div class="formfontdesc hint-color"><#915#></div>
<div class="formfontdesc hint-color" style="margin-left:28px;">
<#3751#>&nbsp;<#3752#><br><#3087#>
</div>
<div class="formfontdesc"><#3753#>
<ol>
<li><#3754#></li>
<li><#3755#></li>
<li><#3756#></li>
...
<div id="wl_bw_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#3758#></div>
<div id="wl_ch_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#3759#></div>
...
<td id="repeaterModeHint_desc" colspan="2" class="hint-color" style="height:30px;" align="center"><#462#></td>
</tr>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#3809#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#3810#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#3811#></option>
</select>
</td>
</tr>
...
<td>
<input type="radio" value="1" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "1", "checked"); %>><#186#>
<input type="radio" value="0" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "0", "checked"); %>><#185#>
</td>
</tr>
</table>
...
<td colspan="4"><#3778#>&nbsp;(<#2576#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#3778#></th>
<th class="edit_table" width="20%"><#2575#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3050#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<div class="apply_gen">
<input class="button_gen" id="submitBtn" onclick="applyRule()" type="button" value="<#195#>" />
</div>
</td>
</tr>
</tbody>
