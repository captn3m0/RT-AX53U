...
add_option(document.form.TriggerKnownApps, "<#720#>", "User Defined", 1);
...
{
"editMode" : "text",
"title" : "<#2343#><div class=\"setup_info_icon\" style=\"display:none;margin-left:185px;\"></div>",
"maxlength" : "11",
...
<div>&nbsp;</div>
<div class="formfonttitle"><#388#> - <#390#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2356#></div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#390#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2565#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
<thead>
<tr>
<td colspan="6"><#3240#></td>
</tr>
</thead>
<tr>
<th colspan="2"><#2342#></th>
<td colspan="4">
<input type="radio" value="1" name="autofw_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'IPConnection', 'autofw_enable_x', '1')" <% nvram_match("autofw_enable_x", "1", "checked"); %>><#186#>
<input type="radio" value="0" name="autofw_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'IPConnection', 'autofw_enable_x', '0')" <% nvram_match("autofw_enable_x", "0", "checked"); %>><#185#>
</td>
</tr>
<tr>
<th colspan="2"align="right" id="autofw_rulelist"><#2359#></th>
<td colspan="4">
<select name="TriggerKnownApps" class="input_option" onChange="change_wizard(this);">
<option value="User Defined"><#720#></option>
</select>
</td>
</tr>
</table>
