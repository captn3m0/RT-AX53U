...
<div>&nbsp;</div>
<div class="formfonttitle"><#2766#> - <#2783#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3124#></div>
<div class="formfontdesc"><#3125#></div>
...
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2784#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2777#>&nbsp;(<#2576#>&nbsp;32)</td>
</tr>
</thead>
<tr>
