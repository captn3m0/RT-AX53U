...
code +='<tr><td style="color:#FC0;" colspan="6"><#2448#></td></tr>';
else{
for(var i = 0; i < vpnc_clientlist_array.length; i += 1) {
if(vpnc_clientlist_array[i] != "") {
...
code += '<td width="25%"><input class="button_gen" type="button" onClick="connect_Row(this, \'disconnect\');" id="disonnect_btn" value="<#1672#>" style="padding:0 0.3em 0 0.3em;" >';
}
else{ //OpenVPN is not connecting
code += '<td width="10%"><input class="remove_btn" type="button" onclick="del_Row(this, \'vpnc\');" value=""/></td>';
code += '<td width="25%"><input class="button_gen" type="button" onClick="connect_Row(this, \'vpnc\');" id="Connect_btn" name="Connect_btn" value="<#1664#>" style="padding:0 0.3em 0 0.3em;" >';
}
}
else{
if( vpnc_proto == document.form.vpnc_proto.value.toUpperCase()
...
break;
case '2' :
code +='<td width="10%" title="<#1644#>"><img src="/images/InternetScan.gif" style="width:25px;"></td>';
break;
case '3' :
...
code +='<td width="25%">';
if(ipsec_profilelist_arraylist[i][38] == 0) {
code += '<input class="button_gen" type="button" onClick="connect_Row_IPSec(this, \''+ipsec_profilelist_arraylist[i][0]+'\', \'active\');" value="<#1664#>">';
}
else {
code += '<input class="button_gen" type="button" onClick="connect_Row_IPSec(this, \''+ipsec_profilelist_arraylist[i][0]+'\', \'deactivate\');" value="<#1672#>">';
...
<input class="button_gen" type="button" onclick="addRow_Group(10,save_flag, idx_tmp);" value="<#1687#>">
</div>
</div>
...
<th><#3693#></th>
<td>
<input type="text" class="input_25_table" name="ipsec_local_id" placeholder="<#302#>、FQDN、<#1331#> or DN" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<th><#3694#></th>
<td>
<input type="text" class="input_25_table" name="ipsec_remote_id" placeholder="<#302#>、FQDN、<#1331#> or DN" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<th><#3686#></th>
<td>
<input type="radio" name="ipsec_exchange" class="input" value="1" onchange="changeExchangeMode();"><#1752#>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#1536#></label>
...
<label for='ipsec_dead_peer_detection_clear' id="ipsec_dead_peer_detection_clear_label"><#1669#></label>
...
<input class="button_gen" type="button" onclick="save_ipsec_profile_panel();" value="<#1688#>">
</div>
</td>
</tr>
</table>
...
<input class="button_gen" onclick="ImportOvpn(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" type="button" value="<#1697#>" />
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input id="importCA" class="button_gen" onclick="startImportCA(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" type="button" value="<#1697#>" />
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnCertForm.submit();" type="button" value="<#1697#>" />
</td>
</tr>
</table>
</form>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnKeyForm.submit();" type="button" value="<#1697#>" />
</td>
</tr>
</table>
</form>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnStaticForm.submit();" type="button" value="<#1697#>" />
</td>
</tr>
</table>
</form>
...
<input class="button_gen" type="button" onclick="saveManual(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" value="<#1688#>">
</div>
</td>
</tr>
</table>
...
<input class="button_gen" onclick='addOpenvpnProfile();' type="button" value="<#1687#>">
</div>
</div>
<div id="footer"></div>
</body>
