...
<title><#837#> - WireGuard Server</title>
...
<td>
<input type="radio" value="1" name="wgs_enable" class="input" <% nvram_match("wgs_enable", "1", "checked"); %>><#186#></input>
<input type="radio" value="0" name="wgs_enable" class="input" <% nvram_match("wgs_enable", "0", "checked"); %>><#185#></input>
</td>
</tr>
<tr id="wgs_dns">
<th>Allow DNS</th>
<td>
<input type="radio" value="1" name="wgs_dns" class="input" <% nvram_match("wgs_dns", "1", "checked"); %>><#186#></input>
<input type="radio" value="0" name="wgs_dns" class="input" <% nvram_match("wgs_dns", "0", "checked"); %>><#185#></input>
</td>
</tr>
<tr id="wgs_nat6">
<th>IPv6 NAT</th>
<td>
<input type="radio" value="1" name="wgs_nat6" class="input" <% nvram_match("wgs_nat6", "1", "checked"); %>><#186#></input>
<input type="radio" value="0" name="wgs_nat6" class="input" <% nvram_match("wgs_nat6", "0", "checked"); %>><#185#></input>
</td>
</tr>
<tr id="wgs_psk">
<th>Use Preshared Key</th>
<td>
<input type="radio" value="1" name="wgs_psk" class="input" <% nvram_match("wgs_psk", "1", "checked"); %>><#186#></input>
<input type="radio" value="0" name="wgs_psk" class="input" <% nvram_match("wgs_psk", "0", "checked"); %>><#185#></input>
</td>
</tr>
<tr>
...
<th>Enable Client</th>
<td>
<input type="radio" value="1" name="wgsc_enable" class="input" <% nvram_match("wgsc_enable", "1", "checked"); %>><#186#></input>
<input type="radio" value="0" name="wgsc_enable" class="input" <% nvram_match("wgsc_enable", "0", "checked"); %>><#185#></input>
</td>
</tr>
<tr>
...
<td>
<input class="button_gen" type="button" value="<#1510#>" onClick="exportConfig();"/>
