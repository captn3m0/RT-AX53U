...
<link rel="icon" href="images/favicon.png"><title><#837#> - <#2143#></title>
...
var code = '';
code += '<thead><tr><td colspan="4"><#2185#>&nbsp;(<#2576#>&nbsp;64)</td></tr></thead>';
code += '<tr>';
code += '<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1521#> (<#2913#>)</a></th>';
code += '<th><#2575#></th>';
code += '</tr>';
code += '<tr>';
code += '<td width="40%">';
...
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3055#>">';
...
<div style="padding: 5px 0;font-size:20px;"><#2182#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2183#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2184#></div>
<div onclick="showGameListField();" class="btn" style="margin: 12px 0;width:100px;height:40px;line-height: 40px;text-align: center;border-radius: 5px;font-size:18px;"><#1632#></div>
</td>
<td>
...
<tr>
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2202#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2203#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2204#></div>
</td>
<td>
...
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2205#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2206#></div>
</td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameProfile.asp';"><#1511#></div>
</td>
</tr>
<tr style="height:50px;"></tr>
<tr id='wtfast_1' style="display:none">
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2158#></div>
</td>
<td colspan="2">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2155#></div>
</td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='Advanced_WTFast_Content.asp';"><#1511#></div>
</td>
</tr>
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameBoost_Tencent.asp';"><#1511#></div>
</td>
</tr>
</tbody>
</table>
