...
var ipv6_service_opt = new Array( new Array("<#1536#>", "disabled"),
new Array("Native", "dhcp6"),
new Array("<#2492#>", "other"),
...
<option value="disabled" <% nvram_match("ipv61_service", "disabled", "selected"); %>><#1536#></option>
<option value="dhcp6" <% nvram_match("ipv61_service", "dhcp6", "selected"); %>><#2484#></option>
<option value="other" <% nvram_match("ipv61_service", "other", "selected"); %>><#2492#></option>
<option value="ipv6pt" <% nvram_match("ipv61_service", "ipv6pt", "selected"); %>><#2475#></option>
<option value="flets" <% nvram_match("ipv61_service", "flets", "selected"); %>><#2474#></option>
<option value="6to4" <% nvram_match("ipv61_service", "6to4", "selected"); %>><#2495#></option>
<option value="6in4" <% nvram_match("ipv61_service", "6in4", "selected"); %>><#2494#></option>
<option value="6rd" <% nvram_match("ipv61_service", "6rd", "selected"); %>><#2496#></option>
</select>
</td>
</tr>
<tr>
...
<input type="radio" name="ipv61_dhcp_pd" class="input" value="0" onclick="showInputfield2('ipv61_dhcp_pd', this.value);" <% nvram_match("ipv61_dhcp_pd", "0","checked"); %>><#1536#>
</td>
</tr>
...
<input type="radio" name="_ipv61_accept_defrtr" class="input" value="0" <% nvram_match("ipv61_accept_defrtr", "0","checked"); %>><#1536#>
</td>
</tr>
...
<input type="radio" name="ipv61_6rd_dhcp" class="input" value="0" onclick="showInputfield2('ipv61_6rd_dhcp', this.value);" <% nvram_match("ipv61_6rd_dhcp", "0","checked"); %>><#1536#>
</td>
</tr>
<tr style="display:none;">
<th><#2469#></th>
...
<input type="radio" name="ipv61_dnsenable" class="input" value="0" onclick="showInputfield2('ipv61_dnsenable', this.value);" <% nvram_match("ipv61_dnsenable", "0","checked"); %>><#1536#>
...
<input type="radio" name="_ipv61_radvd" class="input" value="0" <% nvram_match("ipv61_radvd", "0","checked"); %>><#1536#>
</td>
</tr>
</table>
<div class="apply_gen">
