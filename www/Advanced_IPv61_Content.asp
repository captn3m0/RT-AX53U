...
var ipv6_service_opt = new Array( new Array("<#1507#>", "disabled"),
new Array("Native", "dhcp6"),
new Array("<#2412#>", "other"),
...
alert("<#3473#> "+document.form.ipv61_dhcp_start_start.value);
...
<option value="disabled" <% nvram_match("ipv61_service", "disabled", "selected"); %>><#1507#></option>
<option value="dhcp6" <% nvram_match("ipv61_service", "dhcp6", "selected"); %>><#2408#></option>
<option value="other" <% nvram_match("ipv61_service", "other", "selected"); %>><#2412#></option>
<option value="ipv6pt" <% nvram_match("ipv61_service", "ipv6pt", "selected"); %>><#2399#></option>
<option value="flets" <% nvram_match("ipv61_service", "flets", "selected"); %>><#2398#></option>
<option value="6to4" <% nvram_match("ipv61_service", "6to4", "selected"); %>><#2415#></option>
<option value="6in4" <% nvram_match("ipv61_service", "6in4", "selected"); %>><#2414#></option>
<option value="6rd" <% nvram_match("ipv61_service", "6rd", "selected"); %>><#2416#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="eth" <% nvram_match("ipv61_ifdev", "eth","selected"); %>><#3630#></option>
</select>
</td>
</tr>
<tr style="display:none;"><th>DHCP-PD</th>
<td>
<input type="radio" name="ipv61_dhcp_pd" class="input" value="1" onclick="showInputfield2('ipv61_dhcp_pd', this.value);" <% nvram_match("ipv61_dhcp_pd", "1","checked"); %>><#3797#>
<input type="radio" name="ipv61_dhcp_pd" class="input" value="0" onclick="showInputfield2('ipv61_dhcp_pd', this.value);" <% nvram_match("ipv61_dhcp_pd", "0","checked"); %>><#1507#>
</td>
</tr>
<tr style="display:none;"><th><#2395#></th>
<td>
<input type="radio" name="_ipv61_accept_defrtr" class="input" value="1" <% nvram_match("ipv61_accept_defrtr", "1","checked"); %>><#3797#>
<input type="radio" name="_ipv61_accept_defrtr" class="input" value="0" <% nvram_match("ipv61_accept_defrtr", "0","checked"); %>><#1507#>
</td>
</tr>
...
<th><#2391#></th>
<td>
<input type="radio" name="ipv61_6rd_dhcp" class="input" value="1" onclick="showInputfield2('ipv61_6rd_dhcp', this.value);" <% nvram_match("ipv61_6rd_dhcp", "1","checked"); %>><#3797#>
<input type="radio" name="ipv61_6rd_dhcp" class="input" value="0" onclick="showInputfield2('ipv61_6rd_dhcp', this.value);" <% nvram_match("ipv61_6rd_dhcp", "0","checked"); %>><#1507#>
</td>
</tr>
<tr style="display:none;">
<th><#2393#></th>
...
<th><#303#></th>
<td>
<input type="radio" name="ipv61_dnsenable" class="input" value="1" onclick="showInputfield2('ipv61_dnsenable', this.value);" <% nvram_match("ipv61_dnsenable", "1","checked"); %>><#3797#>
<input type="radio" name="ipv61_dnsenable" class="input" value="0" onclick="showInputfield2('ipv61_dnsenable', this.value);" <% nvram_match("ipv61_dnsenable", "0","checked"); %>><#1507#>
...
<th><#1863#></th>
<td>
<input type="radio" name="_ipv61_radvd" class="input" value="1" <% nvram_match("ipv61_radvd", "1","checked"); %>><#3797#>
<input type="radio" name="_ipv61_radvd" class="input" value="0" <% nvram_match("ipv61_radvd", "0","checked"); %>><#1507#>
</td>
</tr>
</table>
<div class="apply_gen">
