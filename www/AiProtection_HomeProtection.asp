...
if(<% check_acorpw(); %> == 1){
danger_count++;
document.getElementById('login_password').innerHTML = "<a href='Advanced_System_Content.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('login_password').innerHTML = "<#186#>";
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#466#>"; }
...
safe_count++;
document.getElementById('wireless_encryption').innerHTML = "<#469#>";
document.getElementById('wireless_encryption').className = "status_yes";
}
else{
danger_count++;
document.getElementById('wireless_encryption').innerHTML = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#467#></a>";
...
if(wps_enable == 0){
safe_count++;
document.getElementById('wps_status').innerHTML = "<#186#>";
document.getElementById('wps_status').className = "status_yes";
}
else{
risk_count++;
document.getElementById('wps_status').innerHTML = "<a href='Advanced_WWPS_Content.asp' target='_blank'><#185#></a>";
...
document.getElementById('upnp_service').innerHTML = "<a><#185#></a>";
...
document.getElementById('upnp_service').innerHTML = "<#186#>";
...
if(risk_upnp>0){
document.getElementById('upnp_service').innerHTML = "<a href='"+redirect_page+"' target='_blank'><#185#></a>";
document.getElementById('upnp_service').className = "status_no_risk";
document.getElementById('upnp_service').onmouseover = function(){overHint(13);}
document.getElementById('upnp_service').onmouseout = function(){nd();}
}
...
safe_count++;
document.getElementById('access_from_wan').innerHTML = "<#186#>";
document.getElementById('access_from_wan').className = "status_yes";
}
else{
risk_count++;
document.getElementById('access_from_wan').innerHTML = "<a href='Advanced_System_Content.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('ping_from_wan').innerHTML = "<#186#>";
document.getElementById('ping_from_wan').className = "status_yes";
}
else{
risk_count++;
document.getElementById('ping_from_wan').innerHTML = "<a href='Advanced_BasicFirewall_Content.asp' target='_blank'><#185#></a>";
...
if(document.form.dmz_ip.value == ""){
safe_count++;
document.getElementById('dmz_service').innerHTML = "<#186#>";
document.getElementById('dmz_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('dmz_service').innerHTML = "<a href='Advanced_Exposed_Content.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('port_tirgger').innerHTML = "<#186#>";
document.getElementById('port_tirgger').className = "status_yes";
}
else{
risk_count++;
document.getElementById('port_tirgger').innerHTML = "<a href='Advanced_PortTrigger_Content.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('port_forwarding').innerHTML = "<#186#>";
document.getElementById('port_forwarding').className = "status_yes";
}
else{
risk_count++;
document.getElementById('port_forwarding').innerHTML = "<a href='Advanced_VirtualServer_Content.asp' target='_blank'><#185#></a>";
...
if(ftp_account_mode == 1){
risk_count++;
document.getElementById('ftp_account').innerHTML = "<a href='Advanced_AiDisk_ftp.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('ftp_account').innerHTML = "<#186#>";
...
if(samba_account_mode == 1){
risk_count++;
document.getElementById('samba_account').innerHTML = "<a href='Advanced_AiDisk_samba.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('samba_account').innerHTML = "<#186#>";
...
safe_count++;
document.getElementById('wrs_service').innerHTML = "<#186#>";
document.getElementById('wrs_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('wrs_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('vp_service').innerHTML = "<#186#>";
document.getElementById('vp_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('vp_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#185#></a>";
...
safe_count++;
document.getElementById('cc_service').innerHTML = "<#186#>";
document.getElementById('cc_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('cc_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#185#></a>";
...
<tr>
<td>
<div class="weakness_router_status"><#1235#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<input class="button_gen" type="button" onclick="close_weakness_status();" value="<#1637#>">
</td>
<td>
<input id="all_security_btn" class="button_gen" type="button" onclick="enable_whole_security();" value="<#1662#>">
</td>
</tr>
</table>
</td>
...
<tr>
<th>
<div style="font-size:16px;"><#1183#></div>
</th>
</tr>
<td>
<div class="formfontdesc" style="font-size: 14px;"><#1231#></div>
</td>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_alert_preference();" value="<#1637#>">
<input class="button_gen" type="button" onclick="apply_alert_preference();" value="<#195#>">
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div style="width:430px"><#1232#></div>
<div style="width:430px">
<a id="faq" style="text-decoration:underline;" href="" target="_blank"><#1277#> FAQ</a>
</div>
</td>
<td>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1235#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1236#></div>
</td>
<td width="6px">
...
<td style="width:20%;">
<div>
<input class="button_gen" type="button" onclick="showWeaknessTable();" value="<#1660#>">
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1274#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1273#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size: 16px;"><#1266#></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1293#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1294#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1187#></div>
<div style="font-size: 14px;color:#FC0;height:auto;;padding-top:5px;"><#1186#></div>
</td>
<td>
<div class="line_vertical"></div>
</td>
...
<input class="button_gen" type="button" onclick="show_alert_preference();" value="<#1183#>">
</div>
</div>
