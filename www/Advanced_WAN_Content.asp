...
$("#dhcpdns_hint_dnspriv").html("<span><#1731#></span>");
...
$("#dotPresets").children().remove().end().append("<option value='-1'><#725#></option>");
...
if(!is_ipv4 && !is_ipv6) {
alert(document.form.dnspriv_server_0.value + "<#334#>");
document.form.dnspriv_server_0.focus();
return false;
}
...
var DNSListTableCategory=["<#303#>", "<#304#>", "<#305#>", "Safe", "<#306#>"];
var code="";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='4'><#1651#>";
code += "</td></tr></thead>";
...
code += "<tr><td>";
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='4'><#375#>";
code += "</td></tr></thead>";
...
code += "<input class='button_gen' type='button' onclick='Update_DNS_service()' style='margin-left:15px;' value='<#1665#>'>";
code += "</div>";
...
DSN_status_info += "<br><b><#1509#>:</b> "+DNSService[DNS_list_index].DNSService; /* Untranslated */
DSN_status_info += "<br><b><#487#>:</b> "+document.form.wan_dns1_x.value+", "+document.form.wan_dns2_x.value; /* Untranslated */
}
else{
DSN_status_info = "<b><#487#>:</b> "+document.form.wan_dns1_x.value; /* Untranslated */
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,22);"><#1872#></a></th>
<td>
...
<th><#2204#>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq_nat" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">FAQ</a></th>
<td>
<select name="nat_type" class="input_option">
<option value="0" <% nvram_match("nat_type", "0", "selected"); %>><#2205#></option>
<option value="1" <% nvram_match("nat_type", "1", "selected"); %>><#2206#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,23);"><#1437#></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">UPnP&nbspFAQ</a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,12);"><#487#></a></th>
<td>
<div id="DNS_status"></div>
<div style="margin:10px 0 5px 5px;" class="splitLine_dns"></div>
<div class="assign_dns"><#1786#></div>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd);"><#616#></div>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#788#></a></th>
<td align="left">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,30);"><#1729#></a></th>
<td>
