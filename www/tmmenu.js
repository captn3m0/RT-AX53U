...
if(!wireless_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="wireless_tabs"><#382#></a>');
buf.push('<ul>');
...
if(!internet_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="internet_tabs"><#394#></a>');
buf.push('<ul>');
...
buf.push('<li><a style="margin-right: 3px;" href="javascript:tabSelect(\'' + arguments[i][0] + '\')" id="' + arguments[i][0] + '">' + '<#394#> (' + arguments[i][1] + ')</a></li>');
}
