...
if(!wireless_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="wireless_tabs"><#396#></a>');
buf.push('<ul>');
...
if(!internet_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="internet_tabs"><#408#></a>');
buf.push('<ul>');
...
buf.push('<li><a style="margin-right: 3px;" href="javascript:tabSelect(\'' + arguments[i][0] + '\')" id="' + arguments[i][0] + '">' + '<#408#> (' + arguments[i][1] + ')</a></li>');
}
...
if(!wired_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="wired_tabs"><#3383#></a>');
buf.push('<ul>');
