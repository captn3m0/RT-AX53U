...
<title><#842#> - Revert Firmware</title>
...
notice = "<#2146#><br><br>If you would like to revert to previous firmware version, we suggest you temporarily disable auto firmware update to make sure you grant every upgrade."; //Untranslated
confirm_asus({
