...
<title><#860#> - Revert Firmware</title>
...
notice = "<#2168#><br><br>If you would like to revert to previous firmware version, we suggest you temporarily disable auto firmware update to make sure you grant every upgrade."; //Untranslated
confirm_asus({
...
<td>
<input type="button" class="button_gen" style="margin-bottom:10px;" onclick="closeWindow()" value="<#1670#>" />
</td>
</tr>
</table>
