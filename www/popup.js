...
showtext(document.getElementById("proceeding_main_txt"), "<#364#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#367#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#364#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#366#>"));
