...
showtext(document.getElementById("proceeding_main_txt"), "<#368#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#371#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#368#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#370#>"));
