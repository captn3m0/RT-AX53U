...
showtext(document.getElementById("proceeding_main_txt"), "<#363#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#366#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#363#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#365#>"));
