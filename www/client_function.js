...
code += '<span title="Change to default client icon" onclick="card_setDefaultIcon();"><#1673#></span>';
code += '<span id="card_changeIconTitle" title="Change client icon" style="margin-left:10px;" onclick="card_show_custom_image();"><#1667#></span>';
code += '</div>';
}
code += '</td>';
...
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(block_internet_hint) +"\");' onmouseout='return nd();'><#1555#></span>";
code += '</div>';
...
code += '<div style="height:33px;width:100%;margin:5px 0;">';
code += '<div style="width:65%;float:left;line-height:33px;">';
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(ip_binding_hint) +"\");' onmouseout='return nd();'><#1557#></span>";
code += '</div>';
...
document.getElementById("card_client_ipMethod").style.display = "";
document.getElementById("card_client_ipMethod").innerHTML = "<#1561#>";
...
document.getElementById("card_client_login").innerHTML = "<#1559#>";
}
if(clientInfo.isPrinter) {
document.getElementById("card_client_printer").style.display = "";
document.getElementById("card_client_printer").innerHTML = "<#1560#>";
}
...
document.getElementById("card_changeIconTitle").innerHTML = "<#1670#>";
}
else {
slideFlag = true;
slideUp("card_custom_image", 500);
document.getElementById("card_changeIconTitle").innerHTML = "<#1667#>";
}
}
}
...
code += '<th width="15%"><#1554#></th>';
code += '<th width="10%"><#1671#></th>';
code += '</tr>';
code += '</table>';
...
code += '<input class="button_gen" type="button" onclick="uploadIcon_confirm();" value="<#1687#>">';
...
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#1413#></div>";
...
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#1413#></div>";
drawSwitchModeHtml += "</div>";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='" + wl_colspan + "'><#1564#>";
code += "<a id='all_expander'class='clientlist_expander' onclick='showHideContent(\"clientlist_all_list_Block\", this);'>[ <#1565#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_all_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2367#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1554#></th>";
...
code += "<a id='wired_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wired_list_Block\", this);'>[ <#1565#> ]</a>";
code += "</td></tr></thead>";
...
code += "<a id='wl" + wl_map[wl_nband_title[i]] + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wl" + wl_map[wl_nband_title[i]] + "_list_Block\", this);'>[ <#1565#> ]</a>";
code += "</td></tr></thead>";
...
code += "<a id='gn" + i + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_gn" + i + "_list_Block\", this);'>[ <#1565#> ]</a>";
code += "</td></tr></thead>";
...
if(!top.isIE8)
code += "<div style='text-align:center;margin-top:15px;'><input type='button' class='button_gen' onclick='exportClientListLog();' value='<#1539#>'></div>";
code += "</td></tr></tbody>";
code += "</table>";
divObj.innerHTML = code;
...
document.getElementById("all_expander").innerHTML = "[ <#1566#> ]";
}
}
else {
$.each(isWL_map, function(index, value){
...
document.getElementById("wired_expander").innerHTML = "[ <#1566#> ]";
}
}
else{
if(!sorter["wl"+index+"_display"]){
document.getElementById("clientlist_wl"+index+"_list_Block").style.display = "none";
document.getElementById("wl"+index+"_expander").innerHTML = "[ <#1566#> ]";
}
}
});
if(isSupport("amas")){
...
document.getElementById("gn"+i+"_expander").innerHTML = "[ <#1566#> ]";
}
}
}
}
...
clientListCode += "<tr id='tr_" + objID + "'><td style='color:#FFCC00;' colspan='" + wl_colspan + "'><#2448#></td></tr>";
}
else {
...
{tag:"#CLIENTLIST_ELECTRONIC_DEVICES",text:"<#1567#>"},
{tag:"#CLIENTLIST_DESKTOP",text:"<#1568#>"},
{tag:"#CLIENTLIST_WINDOWS_DESKTOP",text:"<#1569#>"},
{tag:"#CLIENTLIST_LINUX_DESKTOP",text:"<#1570#>"},
{tag:"#CLIENTLIST_LINUX_DEVICE",text:"<#1571#>"},
{tag:"#CLIENTLIST_SMARTPHONE",text:"<#1572#>"},
{tag:"#CLIENTLIST_IPHONE",text:"<#1573#>"},
{tag:"#CLIENTLIST_ASUS_SMARTPHONE",text:"<#1574#>"},
{tag:"#CLIENTLIST_WINDOWS_PHONE",text:"<#1575#>"},
{tag:"#CLIENTLIST_ANDROID_PHONE",text:"<#1576#>"},
{tag:"#CLIENTLIST_PAD",text:"<#1577#>"},
{tag:"#CLIENTLIST_IPAD",text:"<#1578#>"},
{tag:"#CLIENTLIST_ASUS_PAD",text:"<#1579#>"},
{tag:"#CLIENTLIST_ANDROID_TABLET",text:"<#1580#>"},
{tag:"#CLIENTLIST_REPEATER",text:"<#1581#>"},
{tag:"#CLIENTLIST_NAS_SERVER",text:"<#1582#>"},
{tag:"#CLIENTLIST_NB",text:"<#1583#>"},
{tag:"#CLIENTLIST_WINDOWS_NB",text:"<#1584#>"},
{tag:"#CLIENTLIST_MACBOOK",text:"<#1585#>"},
{tag:"#Clientlist_ASUS_NB",text:"<#1586#>"},
{tag:"#CLIENTLIST_SD_CARD",text:"<#1587#>"},
{tag:"#CLIENTLIST_ROG_DEVICE",text:"<#1588#>"},
{tag:"#CLIENTLIST_SCANNER",text:"<#1589#>"},
{tag:"#CLIENTLIST_APPLE_DEVICE",text:"<#1590#>"},
{tag:"#CLIENTLIST_ANDROID_DEVICE",text:"<#1591#>"},
{tag:"#CLIENTLIST_WINDOWS_DEVICE",text:"<#1592#>"},
{tag:"#CLIENTLIST_ASUS_DEVICE",text:"<#1593#>"},
{tag:"#CLIENTLIST_MEDIA_ENTERTAINMENT",text:"<#1594#>"},
{tag:"#CLIENTLIST_ELECTRONIC_EQUIPMENT",text:"<#1595#>"},
{tag:"#CLIENTLIST_AIR_CONDITIONER",text:"<#1596#>"},
{tag:"#CLIENTLIST_REFRIGERATOR",text:"<#1597#>"},
{tag:"#CLIENTLIST_WEIGHT_SCALE",text:"<#1598#>"},
{tag:"#CLIENTLIST_ELECTRIC_POT",text:"<#1599#>"},
{tag:"#CLIENTLIST_MICROWAVE_OVEN",text:"<#1600#>"},
{tag:"#CLIENTLIST_AIR_PURIFIER",text:"<#1601#>"},
{tag:"#CLIENTLIST_FAN",text:"<#1602#>"},
{tag:"#CLIENTLIST_DEHUMIDIFIER",text:"<#1603#>"},
{tag:"#CLIENTLIST_WASHING_MACHINE",text:"<#1604#>"},
{tag:"#CLIENTLIST_WATER_HEATER",text:"<#1605#>"},
{tag:"#CLIENTLIST_ELECTRIC_KETTLE",text:"<#1606#>"},
{tag:"#CLIENTLIST_SMART_BULB",text:"<#1607#>"},
{tag:"#CLIENTLIST_SMART_TV",text:"<#1608#>"},
{tag:"#CLIENTLIST_CLEANING_ROBOT",text:"<#1609#>"},
{tag:"#CLIENTLIST_SECURITY",text:"<#1610#>"},
{tag:"#CLIENTLIST_SEISMOGRAPH",text:"<#1611#>"},
{tag:"#CLIENTLIST_SMART_LOCK",text:"<#1612#>"},
{tag:"#CLIENTLIST_WEARABLES",text:"<#1613#>"},
{tag:"#CLIENTLIST_SMART_BRACELET",text:"<#1614#>"},
{tag:"#CLIENTLIST_WATCH",text:"<#1615#>"},
{tag:"#CLIENTLIST_WALL_SWITCH",text:"<#1616#>"},
{tag:"#CLIENTLIST_WINDOW_SENSOR",text:"<#1617#>"},
{tag:"#CLIENTLIST_TEMPERATURE_HUMIDITY_SENSOR",text:"<#1618#>"},
{tag:"#CLIENTLIST_BODY_SENSOR",text:"<#1619#>"},
{tag:"#CLIENTLIST_SMART_PLUG",text:"<#1620#>"},
{tag:"#CLIENTLIST_ROBOT",text:"<#1621#>"},
{tag:"#PRINTER",text:"<#1560#>"},
{tag:"#ROUTER",text:"<#1741#>"},
{tag:"#NAS",text:"<#1743#>"},
{tag:"#IPCAM",text:"<#1744#>"}
];
