...
code += '<input class="button_gen" type="button" style="margin-right:5px;" onclick="card_closeClientListView();" value="<#199#>">';
code += '<input id="card_client_confirm" class="button_gen" type="button" value="<#196#>">';
