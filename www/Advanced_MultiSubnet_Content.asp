...
alertMsg("<#4123#>", ipConflict_cp.ipAddr, ipConflict_cp.netLegalRangeStart, ipConflict_cp.netLegalRangeEnd);
return false;
}
}
if(cp_freewifi_support){
...
<input id="saveButton" class="button_gen" type="button" onclick="" value="<#1687#>">
</div>
</div>
