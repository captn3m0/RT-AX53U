...
document.getElementById("privateIP_notes").innerHTML = "<#3564#>";
...
document.getElementById(username_status).innerHTML = '<#217#>';
}
...
document.getElementById(username_status).innerHTML = '<a class="hintstyle2" href="javascript:void(0);" onClick="showOpenVPNClients(\''+openvpnd_connected_clients[y].username+'\');"><#189#></a>';
break;
}
}
...
alert("<#3498#> " + origin_lan_ip);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
if(lan_ip_subnet == openvpn_server_subnet) {
alert("<#3496#>"+pool_start+" ~ "+pool_end);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
...
alert(document.form.vpn_server_r1.value + " <#330#>");
document.form.vpn_server_r1.focus();
document.form.vpn_server_r1.select();
return false;
}
...
alert(document.form.vpn_server_r2.value + " <#330#>");
document.form.vpn_server_r2.focus();
document.form.vpn_server_r2.select();
return false;
}
...
document.getElementById('openvpn_error_message').innerHTML = "<span><#3529#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && vpn_server1_errno == '4'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3530#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && vpn_server1_errno == '5'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3531#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if((vpnd_state == '-1' && vpn_server1_errno == '0') || (vpnd_state != '2' && vpn_server1_errno == '7')){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3532#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
...
document.getElementById("allowed_client_name").innerHTML = (flag==1)?"<#3468#>":"Common Name(CN)";
}
...
<tr>
<div class="description_down"><#3550#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<p><#3541#> <span style="color:#FFCC00;">----- BEGIN xxx ----- </span>/<span style="color:#FFCC00;"> ----- END xxx -----</span> <#3542#>
<p><#3543#>
</div>
...
<input class="button_gen" type="button" onclick="cancel_Key_panel('tls');" value="<#199#>">
<input class="button_gen" type="button" onclick="save_keys('tls');" value="<#1660#>">
</div>
</td>
</tr>
</form>
...
<div style="margin-top:5px;width:100%;text-align:center;">
<input class="button_gen" type="button" onclick="cancel_Key_panel('secret');" value="<#199#>">
<input class="button_gen" type="button" onclick="save_keys('secret');" value="<#1660#>">
</div>
</td>
</tr>
</tbody>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#170#> - OpenVPN</div>
...
<option value="1" selected><#379#></option>
<option value="2"><#377#></option>
</select>
</td>
</tr>
<tr id="trServerPortBasic">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,6);"><#3746#></a>
...
<div id="portSuggestionBasic" style="color: #FFCC00;"><#3178#></div>
</td>
</tr>
...
<label for="vpn_server_client_access_local"><#3488#></label>
...
<label for="vpn_server_client_access_both"><#3489#></label>
...
<label for="vpn_server_client_access_custom" class="client_access_custom"><#1674#></label>
</td>
</tr>
...
<td>
<div id="export_div">
<input id="exportToLocal" class="button_gen" type="button" value="<#1515#>" />
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(33,2);"><#3615#></a></th>
<td>
<input id="renewCertToLocal" class="button_gen" type="button" value="<#206#>" onClick="renewCert();"/>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,27);"><#3505#></a></th>
<td>
<input id="exportCertToLocal" class="button_gen" type="button" value="<#1515#>" onClick="exportCert();"/>
</td>
</tr>
<tr id="openvpn_import_cert" style="display:none;" data-group="cert_btn">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,28);"><#3506#></a></th>
<td>
<input class="button_gen" type="button" value="<#1669#>" onClick="selectImportFile();"/>
</td>
</tr>
</table>
</div>
...
<td>
<input type="radio" name="vpn_server_x_eas" class="input" value="1"><#187#>
<input type="radio" name="vpn_server_x_eas" class="input" value="0"><#186#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,4);"><#3537#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,5);"><#2375#></a></th>
<td>
...
<div id="portSuggestionAdvanced" style="color: #FFCC00;"><#3178#></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,15);"><#3557#></a></th>
<td>
<input type="radio" name="vpn_server_x_dns" class="input" value="1" onclick="update_visibility();"><#187#>
<input type="radio" name="vpn_server_x_dns" class="input" value="0" onclick="update_visibility();"><#186#>
</td>
</tr>
<tr id="server_pdns">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,16);"><#3511#></a></th>
<td>
<input type="radio" name="vpn_server_pdns" class="input" value="1" <% nvram_match_x("", "vpn_server_pdns", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_pdns" class="input" value="0" <% nvram_match_x("", "vpn_server_pdns", "0", "checked"); %>><#186#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,17);"><#3528#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,26);"><#3515#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,18);"><#3520#></a></th>
<td>
<select name="vpn_server_comp" class="input_option">
<option value="-1" <% nvram_match("vpn_server_comp","-1","selected"); %> ><#3810#></option>
<option value="no" <% nvram_match("vpn_server_comp","no","selected"); %> ><#843#></option>
<option value="yes" <% nvram_match("vpn_server_comp","yes","selected"); %> ><#3809#></option>
<option value="adaptive" <% nvram_match("vpn_server_comp","adaptive","selected"); %> ><#875#></option>
...
<option value="auto" <% nvram_match("vpn_server_firewall","auto","selected"); %> ><#153#></option>
<option value="external" <% nvram_match("vpn_server_firewall","external","selected"); %> ><#1889#></option>
<option value="custom" <% nvram_match("vpn_server_firewall","custom","selected"); %> ><#1674#></option>
</select>
</td>
</tr-->
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,9);"><#3513#></a></th>
<td>
<input type="radio" name="vpn_server_igncrt" class="input" value="1" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_igncrt" class="input" value="0" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "0", "checked"); %>><#186#>
<span id="Hint_fixed_tls_crypto" style="display:none;"><#3514#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,7);"><#3512#></a></th>
<td>
...
<span id="server_tls_crypto_text" onclick="set_Keys('tls');" style="text-decoration:underline;cursor:pointer;"><#3553#></span>
<span id="server_static_crypto_text" onclick="set_Keys('secret');" style="text-decoration:underline;cursor:pointer;"><#3553#></span>
<!-- rm 2017/06/28 span id="server_custom_crypto_text"><#3552#></span-->
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,8);"><#3047#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,10);"><#3516#></a></th>
<td>
<select name="vpn_server_hmac" class="input_option">
<option value="-1" <% nvram_match("vpn_server_hmac","-1","selected"); %> ><#3810#></option>
...
<tr id="server_snnm">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,11);"><#3559#></a></th>
<td>
...
<tr id="server_dhcp">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,13);"><#3527#></a></th>
<td>
<input type="radio" name="vpn_server_dhcp" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_dhcp" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "0", "checked"); %>><#186#>
</td>
</tr>
<tr id="server_range">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,14);"><#3518#></a></th>
<td>
...
<tr id="server_local">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,12);"><#3551#></a></th>
<td>
...
<th><#3554#></th>
<td>
<input type="text" maxlength="4" class="input_6_table" name="vpn_server_poll" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("vpn_server_poll"); %>" autocorrect="off" autocapitalize="off"> <#2632#>
<span style="color:#FC0">(<#3960#>)</span>
</td>
</tr-->
<tr id="server_plan">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,2);"><#3555#></a></th>
<td>
<input type="radio" name="vpn_server_plan" class="input" value="1" <% nvram_match_x("", "vpn_server_plan", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_plan" class="input" value="0" <% nvram_match_x("", "vpn_server_plan", "0", "checked"); %>><#186#>
</td>
</tr>
<tr id="server_rgw">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,3);"><#3556#></a></th>
<td>
<input type="radio" name="vpn_server_rgw" class="input" value="1" <% nvram_match_x("", "vpn_server_rgw", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_rgw" class="input" value="0" <% nvram_match_x("", "vpn_server_rgw", "0", "checked"); %>><#186#>
</td>
</tr>
<tr id="server_reneg">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,19);"><#3560#></a></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="vpn_server_reneg" value="<% nvram_get("vpn_server_reneg"); %>" autocorrect="off" autocapitalize="off"> <#3058#>
<span class="hint-color">(<#3087#> : -1)</span>
</td>
</tr>
<tr id="server_ccd">
<th><#3558#></th>
<td>
<input type="radio" name="vpn_server_ccd" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_ccd" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "0", "checked"); %>><#186#>
</td>
</tr>
<tr id="server_c2c">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,20);"><#3517#></a></th>
<td>
<input type="radio" name="vpn_server_c2c" class="input" value="1" <% nvram_match_x("", "vpn_server_c2c", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_c2c" class="input" value="0" <% nvram_match_x("", "vpn_server_c2c", "0", "checked"); %>><#186#>
</td>
</tr>
<tr id="server_ccd_excl">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,21);"><#3519#></a></th>
<td>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "1", "checked"); %>><#187#>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "0", "checked"); %>><#186#>
</td>
</tr>
</table>
...
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,23);"><#3208#></a></th>
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,24);">Mask</a></th>
<th width="12%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,25);"><#2966#></a></th>
<th width="12%"><#2585#></th>
</tr>
<tr>
...
<option value="0" selected><#186#></option>
...
<input id="mailSendPannelCancel" class="button_gen" type="button" value="<#199#>">
...
<div class="panelSubmiter">
<input id="mailConfigPannelCancel" class="button_gen" type="button" value="<#199#>">
<input id="mailConfigPannelSubmiter" class="button_gen" type="button" value="<#1660#>">
