...
document.getElementById("privateIP_notes").innerHTML = "<#3552#>";
...
document.getElementById(username_status).innerHTML = '<#216#>';
}
...
document.getElementById(username_status).innerHTML = '<a class="hintstyle2" href="javascript:void(0);" onClick="showOpenVPNClients(\''+openvpnd_connected_clients[y].username+'\');"><#188#></a>';
break;
}
}
...
alert("<#3486#> " + origin_lan_ip);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
if(lan_ip_subnet == openvpn_server_subnet) {
alert("<#3484#>"+pool_start+" ~ "+pool_end);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
...
alert(document.form.vpn_server_r1.value + " <#329#>");
document.form.vpn_server_r1.focus();
document.form.vpn_server_r1.select();
return false;
}
...
alert(document.form.vpn_server_r2.value + " <#329#>");
document.form.vpn_server_r2.focus();
document.form.vpn_server_r2.select();
return false;
}
...
document.getElementById('openvpn_error_message').innerHTML = "<span><#3517#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && (vpn_server1_errno == '4' || vpn_server1_errno == '7')){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3518#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && vpn_server1_errno == '5'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3519#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state == '-1' && vpn_server1_errno == '0'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3520#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
...
document.getElementById("allowed_client_name").innerHTML = (flag==1)?"<#3456#>":"Common Name(CN)";
}
...
<tr>
<div class="description_down"><#3538#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<p><#3529#> <span style="color:#FFCC00;">----- BEGIN xxx ----- </span>/<span style="color:#FFCC00;"> ----- END xxx -----</span> <#3530#>
<p><#3531#>
</div>
...
<input class="button_gen" type="button" onclick="cancel_Key_panel('tls');" value="<#198#>">
<input class="button_gen" type="button" onclick="save_keys('tls');" value="<#1655#>">
</div>
</td>
</tr>
</form>
...
<div style="margin-top:5px;width:100%;text-align:center;">
<input class="button_gen" type="button" onclick="cancel_Key_panel('secret');" value="<#198#>">
<input class="button_gen" type="button" onclick="save_keys('secret');" value="<#1655#>">
</div>
</td>
</tr>
</tbody>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#169#> - OpenVPN</div>
...
<option value="1" selected><#378#></option>
<option value="2"><#376#></option>
</select>
</td>
</tr>
<tr id="trServerPortBasic">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,6);"><#3734#></a>
...
<div id="portSuggestionBasic" style="color: #FFCC00;"><#3167#></div>
</td>
</tr>
...
<label for="vpn_server_client_access_local"><#3476#></label>
...
<label for="vpn_server_client_access_both"><#3477#></label>
...
<label for="vpn_server_client_access_custom" class="client_access_custom"><#1669#></label>
</td>
</tr>
...
<td>
<div id="export_div">
<input id="exportToLocal" class="button_gen" type="button" value="<#1510#>" />
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(33,2);"><#3603#></a></th>
<td>
<input id="renewCertToLocal" class="button_gen" type="button" value="<#205#>" onClick="renewCert();"/>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,27);"><#3493#></a></th>
<td>
<input id="exportCertToLocal" class="button_gen" type="button" value="<#1510#>" onClick="exportCert();"/>
</td>
</tr>
<tr id="openvpn_import_cert" style="display:none;" data-group="cert_btn">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,28);"><#3494#></a></th>
<td>
<input class="button_gen" type="button" value="<#1664#>" onClick="selectImportFile();"/>
</td>
</tr>
</table>
</div>
...
<td>
<input type="radio" name="vpn_server_x_eas" class="input" value="1"><#186#>
<input type="radio" name="vpn_server_x_eas" class="input" value="0"><#185#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,4);"><#3525#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,5);"><#2365#></a></th>
<td>
...
<div id="portSuggestionAdvanced" style="color: #FFCC00;"><#3167#></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,15);"><#3545#></a></th>
<td>
<input type="radio" name="vpn_server_x_dns" class="input" value="1" onclick="update_visibility();"><#186#>
<input type="radio" name="vpn_server_x_dns" class="input" value="0" onclick="update_visibility();"><#185#>
</td>
</tr>
<tr id="server_pdns">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,16);"><#3499#></a></th>
<td>
<input type="radio" name="vpn_server_pdns" class="input" value="1" <% nvram_match_x("", "vpn_server_pdns", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_pdns" class="input" value="0" <% nvram_match_x("", "vpn_server_pdns", "0", "checked"); %>><#185#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,17);"><#3516#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,26);"><#3503#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,18);"><#3508#></a></th>
<td>
<select name="vpn_server_comp" class="input_option">
<option value="-1" <% nvram_match("vpn_server_comp","-1","selected"); %> ><#3798#></option>
<option value="no" <% nvram_match("vpn_server_comp","no","selected"); %> ><#842#></option>
<option value="yes" <% nvram_match("vpn_server_comp","yes","selected"); %> ><#3797#></option>
<option value="adaptive" <% nvram_match("vpn_server_comp","adaptive","selected"); %> ><#874#></option>
...
<option value="auto" <% nvram_match("vpn_server_firewall","auto","selected"); %> ><#152#></option>
<option value="external" <% nvram_match("vpn_server_firewall","external","selected"); %> ><#1882#></option>
<option value="custom" <% nvram_match("vpn_server_firewall","custom","selected"); %> ><#1669#></option>
</select>
</td>
</tr-->
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,9);"><#3501#></a></th>
<td>
<input type="radio" name="vpn_server_igncrt" class="input" value="1" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_igncrt" class="input" value="0" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "0", "checked"); %>><#185#>
<span id="Hint_fixed_tls_crypto" style="display:none;"><#3502#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,7);"><#3500#></a></th>
<td>
...
<span id="server_tls_crypto_text" onclick="set_Keys('tls');" style="text-decoration:underline;cursor:pointer;"><#3541#></span>
<span id="server_static_crypto_text" onclick="set_Keys('secret');" style="text-decoration:underline;cursor:pointer;"><#3541#></span>
<!-- rm 2017/06/28 span id="server_custom_crypto_text"><#3540#></span-->
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,8);"><#3036#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,10);"><#3504#></a></th>
<td>
<select name="vpn_server_hmac" class="input_option">
<option value="-1" <% nvram_match("vpn_server_hmac","-1","selected"); %> ><#3798#></option>
...
<tr id="server_snnm">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,11);"><#3547#></a></th>
<td>
...
<tr id="server_dhcp">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,13);"><#3515#></a></th>
<td>
<input type="radio" name="vpn_server_dhcp" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_dhcp" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "0", "checked"); %>><#185#>
</td>
</tr>
<tr id="server_range">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,14);"><#3506#></a></th>
<td>
...
<tr id="server_local">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,12);"><#3539#></a></th>
<td>
...
<th><#3542#></th>
<td>
<input type="text" maxlength="4" class="input_6_table" name="vpn_server_poll" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("vpn_server_poll"); %>" autocorrect="off" autocapitalize="off"> <#2622#>
<span style="color:#FC0">(<#3948#>)</span>
</td>
</tr-->
<tr id="server_plan">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,2);"><#3543#></a></th>
<td>
<input type="radio" name="vpn_server_plan" class="input" value="1" <% nvram_match_x("", "vpn_server_plan", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_plan" class="input" value="0" <% nvram_match_x("", "vpn_server_plan", "0", "checked"); %>><#185#>
</td>
</tr>
<tr id="server_rgw">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,3);"><#3544#></a></th>
<td>
<input type="radio" name="vpn_server_rgw" class="input" value="1" <% nvram_match_x("", "vpn_server_rgw", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_rgw" class="input" value="0" <% nvram_match_x("", "vpn_server_rgw", "0", "checked"); %>><#185#>
</td>
</tr>
<tr id="server_reneg">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,19);"><#3548#></a></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="vpn_server_reneg" value="<% nvram_get("vpn_server_reneg"); %>" autocorrect="off" autocapitalize="off"> <#3047#>
<span class="hint-color">(<#3076#> : -1)</span>
</td>
</tr>
<tr id="server_ccd">
<th><#3546#></th>
<td>
<input type="radio" name="vpn_server_ccd" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_ccd" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "0", "checked"); %>><#185#>
</td>
</tr>
<tr id="server_c2c">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,20);"><#3505#></a></th>
<td>
<input type="radio" name="vpn_server_c2c" class="input" value="1" <% nvram_match_x("", "vpn_server_c2c", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_c2c" class="input" value="0" <% nvram_match_x("", "vpn_server_c2c", "0", "checked"); %>><#185#>
</td>
</tr>
<tr id="server_ccd_excl">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,21);"><#3507#></a></th>
<td>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "1", "checked"); %>><#186#>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "0", "checked"); %>><#185#>
</td>
</tr>
</table>
...
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,23);"><#3197#></a></th>
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,24);">Mask</a></th>
<th width="12%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,25);"><#2955#></a></th>
<th width="12%"><#2575#></th>
</tr>
<tr>
...
<option value="0" selected><#185#></option>
<option value="1"><#186#></option>
</select>
</td>
<td width="12%">
...
<input id="mailSendPannelCancel" class="button_gen" type="button" value="<#198#>">
...
<div class="panelSubmiter">
<input id="mailConfigPannelCancel" class="button_gen" type="button" value="<#198#>">
<input id="mailConfigPannelSubmiter" class="button_gen" type="button" value="<#1655#>">
