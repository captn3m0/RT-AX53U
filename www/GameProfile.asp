...
code += '<div class="table-content1-width"><div><#1224#></div></div>';
code += '<div class="table-content2-width"><div><#1524#></div></div>';
code += '<div class="table-content3-width"><div><#2365#></div></div>';
...
<div class="control-description"><#2361#></div>
...
<div class="new-g-p-s-title"><#2169#></div>
</div>
...
<div class="new-g-p-s-title"><#2172#></div>
</div>
...
<div class="new-g-p-s-title"><#3086#></div>
</div>
<div class="new-p-platform">
<div id="name_field" class="game-p-s-field">
<div class="settings-filed-title"><#1499#></div>
...
<div class="settings-filed-title"><#2365#></div>
<div class="select-container">
<select name="" id="new_profile_protocol">
<option value="TCP">TCP</option>
<option value="UDP">UDP</option>
<option value="BOTH"><#2808#></option>
</select>
...
<div class="settings-filed-title"><#2376#><div class="setup_info_icon_game" style="display:none;"></div></div>
...
<div class="settings-filed-title"><#2378#></div>
...
<div class="hint"><#1973#></div>
</div>
<div id="localIP_field" class="game-p-s-field" >
<div class="settings-filed-title"><#2379#></div>
...
<div class="settings-filed-title"><#2373#></div>
...
<div class="button-text"><#1654#></div>
</div>
</div>
...
<div class="new-g-p-title"><#2169#></div>
<div class="new-g-p-rule"><span id="rule_num">2</span> Rules (<#2576#> 32)</div>
</div>
<div id="list_content">
