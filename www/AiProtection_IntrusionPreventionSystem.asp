...
code += '<div style="display:table-cell;width:70px;padding-right:5px;"><#1748#></div>';
code += '<div style="display:table-cell;width:50px;padding-right:5px;"><#1234#></div>';
code += '<div style="display:table-cell;width:100px;padding-right:5px;">Type</div>';
code += '<div style="display:table-cell;width:100px;padding-right:5px;"><#1196#></div>';
code += '<div style="display:table-cell;width:130px;padding-right:5px;"><#1195#></div>';
code += '<div style="display:table-cell;width:180px;padding-right:5px;"><#1197#></div>';
code += '</div>';
if(data_array == ""){
...
code += '<div style="display:table-cell;width:180px;height:30px;vertical-align:middle;padding-right:5px;text-decoration:underline;cursor:pointer" title="<#1306#>" onclick="threatQuery(\''+ data_array[i][7] +'\', \'' + data_array[i][5].split(" ").slice(0,3).join("+") + '\')">'+ data_array[i][5] + '</div>';
code += '</div>';
}
}
...
<tr>
<td align="left">
<span class="formfonttitle"><#1277#> - <#1293#></span>
</td>
</tr>
</table>
</div>
...
<div style="display:inline-block;font-size:14px;vertical-align:bottom;padding: 5px 0" title="<#1236#>"><#1274#></div-->
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center;"><#1233#></div>
...
<div style="margin: 0 8px;"><div id="save_icon" class="icon-container icon-save" title="<#1655#>" onclick="download(csvContent, 'IntrusionPreventionSystem.csv', 'data:text/csv;charset=utf-8');"></div></div>
...
<div style="display:table-cell;width:70px;padding-right:5px;"><#1748#></div>
<div style="display:table-cell;width:50px;padding-right:5px;"><#1234#></div>
<div style="display:table-cell;width:100px;padding-right:5px;">Type</div>
<div style="display:table-cell;width:100px;padding-right:5px;"><#1196#></div>
<div style="display:table-cell;width:130px;padding-right:5px;"><#1195#></div>
<div style="display:table-cell;width:180px;padding-right:5px;"><#1197#></div>
</div>
</div>
</div>
</div>
