...
<script>
var rescan = 0;
var DEVICE_TYPE = ["", "<#1705#>", "<#1706#>", "<#1707#>", "<#1708#>", "<#1709#>", "<#1710#>", "Printer", "TV Game Console"];
var thisDevice;
(function(){
var thisDeviceObj = {
type: '<3',
...
HTMLCode += '<tr><td style="color:#FFCC00;font-size:12px; border-collapse: collapse;border:1;" colspan="4"><span style="line-height:25px;"><#1701#></span>&nbsp;<img style="margin-top:10px;" src="/images/InternetScan.gif"></td></tr>';
HTMLCode += '</table>';
...
document.getElementById("leftBtn").title = "<#2936#>";
}
if(endNum == client_list_row.length){
document.getElementById("rightBtn").style.visibility = "hidden";
}else{
document.getElementById("rightBtn").style.visibility = "";
document.getElementById("rightBtn").title = "<#2788#>";
}
}
...
if(list)
document.getElementById("isblockdesc").innerHTML = "<#1512#>";
...
code += '<td width="6%" class="border4"><div border="0px"><a title="<#3054#>" target="_blank" href="http://'+ client_list_col[2] +'"><img src="../images/arrow-right.png" width="32px" hight="20px" style="border:0px"></a></div></td>';
}
else
code += '';
}
...
document.getElementById("proceeding_img_text1").innerHTML = "<#365#>";
y = 0;
...
<input type="button" id="refresh_list" class="button_gen" onclick="networkmap_update();" value="<#1657#>">
