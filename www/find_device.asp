...
<script>
var rescan = 0;
var DEVICE_TYPE = ["", "<#1740#>", "<#1741#>", "<#1742#>", "<#1743#>", "<#1744#>", "<#1745#>", "Printer", "TV Game Console"];
var thisDevice;
(function(){
var thisDeviceObj = {
type: '<3',
...
HTMLCode += '<tr><td style="color:#FFCC00;font-size:12px; border-collapse: collapse;border:1;" colspan="4"><span style="line-height:25px;"><#1736#></span>&nbsp;<img style="margin-top:10px;" src="/images/InternetScan.gif"></td></tr>';
HTMLCode += '</table>';
...
document.getElementById("leftBtn").title = "<#3028#>";
}
if(endNum == client_list_row.length){
document.getElementById("rightBtn").style.visibility = "hidden";
}else{
document.getElementById("rightBtn").style.visibility = "";
document.getElementById("rightBtn").title = "<#2873#>";
}
}
...
if(list)
document.getElementById("isblockdesc").innerHTML = "<#1542#>";
...
code += '<td width="6%" class="border4"><div border="0px"><a title="<#3161#>" target="_blank" href="http://'+ client_list_col[2] +'"><img src="../images/arrow-right.png" width="32px" hight="20px" style="border:0px"></a></div></td>';
}
else
code += '';
}
...
document.getElementById("proceeding_img_text1").innerHTML = "<#384#>";
y = 0;
...
<input type="button" id="refresh_list" class="button_gen" onclick="networkmap_update();" value="<#1690#>">
