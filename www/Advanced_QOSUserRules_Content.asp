...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#725#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#334#>");
return false;
}
}
}
