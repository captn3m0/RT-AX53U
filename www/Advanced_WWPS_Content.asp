...
loadXML();
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#2168#> <#4069#>";
...
document.getElementById("wps_band_hint").innerHTML = "* <#4045#>";
return false;
}
...
if(wps_enable_old == "1"){
document.getElementById("wps_enable_word").innerHTML = "<#1538#>";
document.getElementById("enableWPSbtn").value = "<#1536#>";
...
document.getElementById("wps_enable_hint").innerHTML = "* <#2881#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#1540#></a>"
controlDisplayItem();
return;
}
...
document.getElementById("wps_enable_hint").innerHTML = "<#4072#><br><#4073#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#397#></a> <#4074#>"
controlDisplayItem();
return;
}
if(wps_enable_old == "0"){
document.getElementById("wps_state_tr").style.display = "";
document.getElementById("wps_state_td").innerHTML = "<#4071#>";
...
document.getElementById("wps_config_td").innerHTML = "<#1538#>";
}
...
if(radio_2 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(0);\"><#1540#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a>"
}
if(radio_5 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(1);\"><#1540#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a>"
}
...
document.getElementById("wps_enable_hint").innerHTML = "<#4072#><br><#4073#> " + band_link + " <#4074#>";
if (rej0 && rej1){
document.getElementById("wps_state_tr").style.display = "none";
document.getElementById("devicePIN_tr").style.display = "none";
document.getElementById("wpsmethod_tr").style.display = "none";
...
document.getElementById("wps_state_td").innerHTML = "<#4071#> / <#4071#>";
document.getElementById("WPSConnTble").style.display = "none";
document.getElementById("wpsDesc").style.display = "none";
}
else{
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(13,1);"><#4043#></a></th>
<td>
...
<tr id="wps_band_tr">
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,5);"><#1700#></th>
<td id="wps_switch">
...
<td style="border:0px">
<input class="button_gen" type="button" onClick="resetWPS();" id="Reset_OOB" name="Reset_OOB" value="<#1691#>" style="padding:0 0.3em 0 0.3em;" >
...
<tr id="wpsmethod_tr">
<th>
<span id="wps_method"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,2);"><#4049#></a></span>
</th>
<td>
<input type="radio" name="wps_method" onclick="changemethod(0);" value="0"><#4044#>
<input type="radio" name="wps_method" onclick="changemethod(1);" value="1"><#4051#>
...
<div id="starBtn" style="margin-top:10px;"><input class="button_gen" type="button" style="margin-left:5px;" onClick="configCommand();" id="addEnrolleebtn_client" name="addEnrolleebtn" value="<#4070#>"></div>
</td>
</tr>
</table>
</td>
