...
if(wps_enable_old == "1"){
document.getElementById("wps_enable_word").innerHTML = "<#1519#>";
document.getElementById("enableWPSbtn").value = "<#1517#>";
...
document.getElementById("wps_config_td").innerHTML = "<#1518#>";
else
document.getElementById("wps_config_td").innerHTML = "<#1519#>";
}
...
if(radio_2 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(0);\"><#1521#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a>"
}
if(radio_5 !== "1") {
