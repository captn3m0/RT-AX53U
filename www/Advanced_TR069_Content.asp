...
<input class="button_gen" type="button" onclick="cancel_cert_panel();" value="<#206#>">
<input class="button_gen" type="button" onclick="save_cert();" value="<#1688#>">
</div>
</td>
</tr>
</table>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#424#> - TR-069</div>
