...
<div class="formfontdesc"><#2108#></div>
<!--div class="formfontdesc"><#2074#></div-->
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(9,1);"><#2107#></th>
<td>
<input type="radio" value="1" name="url_enable_x" <% nvram_match("url_enable_x", "1", "checked"); %>><#1677#>
<input type="radio" value="0" name="url_enable_x" <% nvram_match("url_enable_x", "0", "checked"); %>><#1674#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(9,3);"><#2081#></a></th>
<td>
<select name="url_mode_x" class="input_option" onChange="">
<option class="content_input_fd" value="0" <% nvram_match( "url_mode_x", "0", "selected"); %>><#1456#></option>
