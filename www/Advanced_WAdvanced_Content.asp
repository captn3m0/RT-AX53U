...
country_array = [];
var country_selection_list = [["AA", "<#1622#>"], ["CN", "<#1624#>"], ["SG", "<#1628#>"], ["EU", "<#1625#>"], ["KR", "<#1626#>"], ["RU", "<#1627#>"], ["US", "<#1629#>"], ["AU", "<#1623#>"], ["XX", "<#1623#>"]];
...
country_selection_list.push(["GD", "<#1624#>"]);
}
if(EG_mode){
...
document.getElementById('wl_txbf_desc').innerHTML = "<#3813#>";
}
else{
document.getElementById('wl_txbf_desc').innerHTML = "<#3814#>";
}
}
else
{
...
document.getElementById('wl_txbf_desc').innerHTML = "<#3848#>";
inputCtrl(document.form.wl_txbf, 1);
inputCtrl(document.form.wl_itxbf, 1);
}
}
...
var value = ['0', '1', '3'];
var desc = ['<#3810#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO'];
add_options_x2(document.form.wl_ofdma, desc, value, document.form.wl_ofdma.value);
}
else if(Rawifi_support){
var value = ['0', '1', '4', '2','3'];
var desc = ['<#3810#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO', 'DL/UL OFDMA', 'DL/UL OFDMA + MU-MIMO'];
...
var name = country ? country.name : '<#3891#> ' + index;
if(tcode == index){
matched = true;
name += ' (<#3087#>)';
}
...
if(!matched){
code += '<option value='+ tcode +' ><#3087#></option>';
}
code += '</select>';
...
document.getElementById('wl_txPower_field_title').innerHTML = "<#3794#>&nbsp;&nbsp;&nbsp;&nbsp;<20dBm";
document.getElementById('tx_power_desc_EG').innerHTML = "<20dBm";
}
else{
document.getElementById('wl_txPower_field_title').innerHTML = "<#3794#>&nbsp;&nbsp;&nbsp;<23dBm";
...
power_table_desc = ["<#3795#>", "<#3796#>", "<#3797#>", "<#3798#>", "<#3799#>"];
...
if(time_temp == ""){
alert("If you want to deny WiFi radio all time, you should check the '<#3884#>' to No");
return false;
}
...
code +='<thead><tr><td colspan="6" id="LWFilterList"><#2826#></td></tr></thead>';
...
code_temp += "<td><div style=\"width:95px;font-family:Arial,sans-serif,Helvetica;font-size:18px;\"><#1595#></div></td>";
code_temp += '<td><div>';
...
code_temp += '</select>';
code_temp += '</div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0px 30px;"><#2827#></div></td>';
code_temp += '<td><div style="width:90px;height:20px;background:#9CB2BA;"></div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0px 30px;"><#2829#></div></td>';
...
document.getElementById("ctrlBtn").innerHTML += '<input class="button_gen" type="button" onClick="save_wifi_schedule();" value="<#1659#>" style="margin:0 10px;">';
...
var confirm_txt = "<#3789#>";
if(wl_unit_value == '1' || wl_unit_value == '2'){ // 5GHz up
if(band5g_11ax_support){
if(based_modelid == 'RT-AX92U'){
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3813#>");
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3814#>");
}
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3813#>");
...
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3848#>");
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#378#> - <#384#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="titl_desc" class="formfontdesc"><#3772#></div>
...
<tr id="wl_rf_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 1);"><#3884#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 23);"><#3899#></a></th>
<td>
...
<span id="time_setting" style="padding-left:20px;cursor:pointer;text-decoration:underline" onclick="show_wifi_schedule();"><#3256#></span>
</td>
</tr>
<tr id="wl_ap_isolate_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 5);"><#3860#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 31);"><#3000#></a></th>
<td>
<select id="wl_user_rssi_option" class="input_option" onchange="changeRSSI(this.value);">
<option value="1"><#3809#></option>
<option value="0" <% nvram_match("wl_user_rssi", "0","selected"); %>><#3810#></option>
</select>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,34);"><#3833#></a></th>
<td>
<select name="wl_btc_mode" class="input_option">
<option value="0" <% nvram_match("wl_btc_mode", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_btc_mode", "1","selected"); %> ><#3809#></option>
<option value="2" <% nvram_match("wl_btc_mode", "2","selected"); %> ><#3835#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 22);"><#3856#></a></th>
<td>
<select name="wl_igs" class="input_option">
<option value="1" <% nvram_match("wl_igs", "1","selected"); %>><#3809#></option>
<option value="0" <% nvram_match("wl_igs", "0","selected"); %>><#3810#></option>
</select>
</td>
</tr>
<tr id="wl_mrate_select">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 7);"><#3787#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,20);"><#3923#></a></th>
<td>
<select name="wl_plcphdr" class="input_option">
<option value="long" <% nvram_match("wl_plcphdr", "long", "selected"); %>><#3924#></option>
<option value="short" <% nvram_match("wl_plcphdr", "short", "selected"); %>><#3925#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 9);"><#3851#></a></th>
<td>
...
<option value="1" <% nvram_match("wl_ampdu_rts", "1", "selected"); %>><#3809#></option>
<option value="0" <% nvram_match("wl_ampdu_rts", "0", "selected"); %>><#3810#></option>
</select>
</td>
</tr>
<tr id="rts_threshold">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 10);"><#3897#></a></th>
<td>
...
<tr id="wl_dtim_field">
<th><a class="hintstyle" id="wl_dtim_th"><#3844#></a></th>
<td>
...
<tr id="wl_bcn_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 12);"><#3830#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 13);"><#3902#></a></th>
<td>
<select name="wl_frameburst" class="input_option">
<option value="off" <% nvram_match("wl_frameburst", "off","selected"); %>><#3810#></option>
<option value="on" <% nvram_match("wl_frameburst", "on","selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr id="PktAggregate"><th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 16);"><#3880#></a></th>
<td>
<select name="wl_PktAggregate" class="input_option">
<option value="0" <% nvram_match("wl_PktAggregate", "0","selected"); %>><#3810#></option>
<option value="1" <% nvram_match("wl_PktAggregate", "1","selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 14);"><#3905#></a></th>
<td>
...
<option value="on" <% nvram_match("wl_wme", "on", "selected"); %>><#3809#></option>
<option value="off" <% nvram_match("wl_wme", "off", "selected"); %>><#3810#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,15);"><#3876#></a></th>
<td>
<select name="wl_wme_no_ack" id="wl_wme_no_ack" class="input_option">
<option value="off" <% nvram_match("wl_wme_no_ack", "off","selected"); %>><#3810#></option>
<option value="on" <% nvram_match("wl_wme_no_ack", "on","selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr id="wl_wme_apsd_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,17);"><#3825#></a></th>
<td>
<select name="wl_wme_apsd" class="input_option">
<option value="off" <% nvram_match("wl_wme_apsd", "off","selected"); %> ><#3810#></option>
<option value="on" <% nvram_match("wl_wme_apsd", "on","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr id="DLSCapable" class="rept"> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,18);"><#3841#></a></th>
<td>
<select name="wl_DLSCapable" class="input_option">
<option value="0" <% nvram_match("wl_DLSCapable", "0","selected"); %>><#3810#></option>
<option value="1" <% nvram_match("wl_DLSCapable", "1","selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,21);"><#3847#></a></th>
<td>
<select name="wl_noisemitigation" class="input_option" onChange="">
<option value="0" <% nvram_match("wl_noisemitigation", "0","selected"); %>><#3810#></option>
<option value="1" <% nvram_match("wl_noisemitigation", "1","selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);"><#3900#></a></th>
<td>
<select name="traffic_5g" class="input_option">
<option value="1" <% nvram_match("traffic_5g", "1","selected"); %>><#3809#></option>
<option value="0" <% nvram_match("traffic_5g", "0","selected"); %>><#3810#></option>
</select>
</td>
</tr>
<tr id="wl_ampdu_mpdu_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,26);"><#3817#></a></th>
<td>
<select name="wl_ampdu_mpdu" class="input_option">
<option value="0" <% nvram_match("wl_ampdu_mpdu", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_ampdu_mpdu", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr id="wl_ack_ratio_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,27);"><#3815#></a></th>
<td>
<select name="wl_ack_ratio" class="input_option">
<option value="0" <% nvram_match("wl_ack_ratio", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_ack_ratio", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr>
<th id="turbo_qam_title"><a id="turbo_qam_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,28);"><#4214#></a></th>
<td>
<select name="wl_turbo_qam" class="input_option">
<option value="0" <% nvram_match("wl_turbo_qam", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_turbo_qam", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_turbo_qam_brcm_intop", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_turbo_qam_brcm_intop", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr id="wl_80211h_tr" style="display:none;">
<th><a class="hintstyle"><#3812#></a></th>
<td>
<select name="wl1_80211h" class="input_option">
<option value="0" <% nvram_match("wl1_80211h", "0","selected"); %>><#3810#></option>
<option value="1" <% nvram_match("wl1_80211h", "1","selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,32);"><#3826#></a></th>
<td>
<select name="wl_atf" class="input_option">
<option value="0" <% nvram_match("wl_atf", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_atf", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr id="wl_MU_MIMO_field" style="display:none">
<th><a class="hintstyle"><#3788#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_mumimo" class="input_option" onchange="handle_mimo(this.value)" disabled>
<option value="0" <% nvram_match("wl_mumimo", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_mumimo", "1","selected"); %> ><#3809#></option>
</select>
</div>
</td>
</tr>
<tr id="ofdma_field" style="display:none">
<th><a class="hintstyle"><#2813#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_ofdma" class="input_option">
<option value="0" <% nvram_match("wl_ofdma", "0","selected"); %>><#3810#></option>
...
<tr id="wl_txbf_field">
<th><a id="wl_txbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,24);"><#3848#></a></th>
<td>
<select name="wl_txbf" class="input_option" onchange="handle_beamforming(this.value)">
<option value="0" <% nvram_match("wl_txbf", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_txbf", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr id="wl_itxbf_field">
<th><a id="wl_itxbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,25);"><#3903#></a></th>
<td>
<select name="wl_itxbf" class="input_option" disabled>
<option value="0" <% nvram_match("wl_itxbf", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_itxbf", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr id="wl_implicitxbf_field" style="display:none">
<th><a class="hintstyle"><#3903#></a></th>
<td>
<select name="wl_implicitxbf" class="input_option">
<option value="0" <% nvram_match("wl_implicitxbf", "0","selected"); %>><#3810#></option>
<option value="1" <% nvram_match("wl_implicitxbf", "1","selected"); %>><#3809#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("wl_ext_nss", "0","selected"); %>><#3810#></option>
<option value="1" <% nvram_match("wl_ext_nss", "1","selected"); %>><#3809#></option>
</select>
</td>
</tr>
<tr id="wl_txPower_field">
<th><a id="wl_txPower_field_title" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 16);"><#3794#></a></th>
<td>
<div>
<table>
<tr>
...
<option value="0" <% nvram_match("wl_precacen", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_precacen", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_hwol", "0","selected"); %> ><#3810#></option>
<option value="1" <% nvram_match("wl_hwol", "1","selected"); %> ><#3809#></option>
</select>
</td>
</tr>
