...
country_array = [];
var country_selection_list = [["AA", "<#1649#>"], ["CN", "<#1651#>"], ["SG", "<#1655#>"], ["EU", "<#1652#>"], ["KR", "<#1653#>"], ["RU", "<#1654#>"], ["US", "<#1656#>"], ["AU", "<#1650#>"], ["XX", "<#1650#>"]];
...
country_selection_list.push(["GD", "<#1651#>"]);
}
if(EG_mode){
...
if(time_temp == ""){
alert("If you want to deny WiFi radio all time, you should check the '<#4020#>' to No");
return false;
}
...
code +='<thead><tr><td colspan="6" id="LWFilterList"><#2903#></td></tr></thead>';
code +='<tr><th style="width:40%;height:20px;" align="right"><#289#></th>';
...
code_temp += "<td><div style=\"width:95px;font-family:Arial,sans-serif,Helvetica;font-size:18px;\"><#1622#></div></td>";
code_temp += '<td><div>';
...
code_temp += '</select>';
code_temp += '</div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0px 30px;"><#2904#></div></td>';
code_temp += '<td><div style="width:90px;height:20px;background:#9CB2BA;"></div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0px 30px;"><#2906#></div></td>';
...
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="cancel_wifi_schedule();" value="<#206#>" style="margin:0 10px;">';
document.getElementById("ctrlBtn").innerHTML += '<input class="button_gen" type="button" onClick="save_wifi_schedule();" value="<#1687#>" style="margin:0 10px;">';
...
<div id="svc_hint_div" style="display:none;margin-left:5px;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#290#></span></div>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,20);"><#4059#></a></th>
<td>
<select name="wl_plcphdr" class="input_option">
<option value="long" <% nvram_match("wl_plcphdr", "long", "selected"); %>><#4060#></option>
<option value="short" <% nvram_match("wl_plcphdr", "short", "selected"); %>><#4061#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 13);"><#4038#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 14);"><#4041#></a></th>
<td>
...
<tr>
<th id="turbo_qam_title"><a id="turbo_qam_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,28);"><#4353#></a></th>
<td>
...
<th><a id="wl_itxbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,25);"><#4039#></a></th>
<td>
