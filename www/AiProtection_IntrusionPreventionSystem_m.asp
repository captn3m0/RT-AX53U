...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1199#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1748#></div>';
code += '<div class="table-cell"><#1234#></div>';
code += '<div class="table-cell">Type</div>';
code += '<div class="table-cell"><#1196#></div>';
code += '<div class="table-cell"><#1195#></div>';
code += '<div class="table-cell"><#1197#></div>';
code += '</div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1234#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1196#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1195#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1197#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2372#></div>';
}
...
<div>
<div class="card-bg">
<div class="page-title"><#1293#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1700#></div>
<div class="description"><#1294#></div>
</div>
<div class="tm-logo">
...
<div class="page-title"><#1233#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1266#></div>
