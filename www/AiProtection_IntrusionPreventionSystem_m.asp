...
code += '<div class="table-cell"><#1262#></div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1262#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1224#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1223#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1225#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
...
<div>
<div class="card-bg">
<div class="page-title"><#1321#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1735#></div>
<div class="description"><#1322#></div>
</div>
<div class="tm-logo">
