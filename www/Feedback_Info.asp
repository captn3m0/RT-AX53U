...
desc += "<#1934#>: <% nvram_get("dslx_diag_duration"); %>\n";
...
<br>
<br>
<div class="feedback_info_0"><#1982#></div>
<br>
</div>
...
<#1951#>
<br><br>
<#1952#> : ( <a href="mailto:broadband_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top" style="color:#FFCC00;">broadband_feedback@asus.com </a>) <#1953#>
<br>
<#1954#> :
<br>
<ul>
<li id="dbg_dsl_file" style="display:none;"><span onClick="get_split_feedback(1);" style="text-decoration: underline; color:#FFCC00; cursor:pointer;"><#1939#></span></li>
...
<#1951#>
<br><br>
<#1952#> : ( <a href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top" style="color:#FFCC00;">router_feedback@asus.com </a>) <#1953#>
<br>
<#1954#> :
<br>
<ul>
<li id="dbg_rt_file" style="display:none;"><span onClick="get_split_feedback(1);" style="text-decoration: underline; color:#FFCC00; cursor:pointer;"><#1939#></span></li>
...
<br>
<div class="feedback_info_1">We are working hard to improve the firmware of <#838#> and your feedback is very important to us. We will use your feedbacks and comments to strive to improve your ASUS experience.</div>
<br>
</div>
...
<input class="button_gen" onclick="redirect();" type="button" value="<#365#>"/>
</div>
</td>
</tr>
</tbody>
