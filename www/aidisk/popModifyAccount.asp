...
showtext(document.getElementById("alert_msg2"),"*<#277#>");
...
showtext(document.getElementById("alert_msg2"),"*<#278#>");
document.getElementById("confirm_password").focus();
return false;
}
...
showtext(document.getElementById("alert_msg2"),"*<#368#>");
...
<thead>
<tr>
<td colspan="2"><span style="color:#FFF"><#2806#>: </span><span style="color:#FFF" id="selected_account"></span><img src="../images/button-close.gif" onClick="parent.hidePop('OverlayMask');"></td>
</tr>
</thead>
<tbody>
<tr valign="middle">
<td height="30" colspan="2" class="hint_word"><#2804#></td>
</tr>
<tr>
<th><#979#>: </th>
<td>
...
<tr>
<th colspan="2" align="right"><input id="Submit" type="button" class="button_gen" value="<#210#>"></th>
</tr>
</table>
</form>
</body>
