...
document.getElementById("settingBtn").innerHTML = "<#1658#>";
show_share_link();
}
else{
document.getElementById("linkdiskbox").style.display = 'none';
...
if(FTP_status != 1)
showtext(document.getElementById("noWAN_link"), '<#2572#>');
else if(ddns_enable != 1){
showtext(document.getElementById("noWAN_link"), "<#2573#>");
document.getElementById("desc_2").style.display = "";
document.getElementById("ddnslink1_LAN").style.display = "";
if(FTP_mode == 1){
showtext(document.getElementById("ddnslink1_LAN"), 'LAN FTP address: <a id="ddnslink1_LAN_link" target="_blank" style="text-decoration: underline; font-family:Lucida Console;">ftp://<% nvram_get("lan_ipaddr"); %></a>');
...
showtext(document.getElementById("noWAN_link"), "<#2574#>");
}else
...
<span style="margin-left:3px;"><#987#></span>
<img onclick="go_setting_parent('/APP_Installation.asp')" align="right" style="cursor:pointer;margin-right:20px;margin-top:-20px;" title="<#374#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</td>
</tr>
<tr>
<td height="20">
...
<div id="Nodisk_hint" class="alert_string" style="display:none;"><#2791#></div>
...
<span style="margin-left:5px;"><#982#></span><br/>
<ul>
...
<div id="gotonext">
<div class="titlebtn" style="margin-left:300px;_margin-left:150px;" align="center"><span id="settingBtn" style="*width:190px;" onclick="go_next_page();"><#1511#></span></div>
</div>
</td>
</tr>
</table>
