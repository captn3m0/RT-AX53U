...
<thead>
<tr>
<td><span style="color:#FFF"><#1709#>: </span><span style="color:#FFF" id="selected_account"></span><img src="../images/button-close.gif" onClick="parent.hidePop('OverlayMask');"></td>
</tr>
</thead>
<tbody>
<tr>
<td height="80" class="hint_word"><#1708#></td>
</tr>
</tbody>
<tr>
<td height="30" align="right">
<input id="Submit" type="button" class="button_gen" value="<#1649#>">
